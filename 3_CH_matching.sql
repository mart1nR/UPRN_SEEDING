CREATE TABLE AD_BASE_CUT AS SELECT
* FROM AD_BASE WHERE 
CLASSIFICATION_TERTIARY ='Care / Nursing Home' ;

ALTER TABLE AD_BASE_CUT COMPRESS;
...
--------------------------
alter table SECOND_A parallel 12;
commit;

ALTER TABLE AD_BASE_CUT
ADD range_lower varchar(250);
ALTER TABLE AD_BASE_CUT
ADD range_upper varchar(250);

UPDATE AD_BASE_CUT SET range_LOWER =CAST(regexp_replace(regexp_substr(AD_BASE_CUT.ADD_num, '[^/]+[0-9]', 1, 1), '[^0-9]','')AS INT);
UPDATE AD_BASE_CUT SET range_upper =CAST(regexp_replace(regexp_substr(AD_BASE_CUT.ADD_num, '[^/]+[0-9]', 1, 2), '[^0-9]','')AS INT);
...
UPDATE SECOND_A SET BUILD_NO =TRIM(Regexp_replace(second_a.BUILD_NO,'[/]','-'));
...
UPDATE AD_BASE_CUT SET BUILD_NO =TRIM(Regexp_replace(AD_BASE_CUT.BUILD_NO,'[/]','-'));
UPDATE AD_BASE_CUT SET range_LOWER2 =CAST(regexp_replace(regexp_substr(AD_BASE_CUT.BUILD_NO, '[^- ]+[0-9]', 1, 1), '[^0-9]','')AS INT);
UPDATE AD_BASE_CUT SET range_upper2 =CAST(regexp_replace(regexp_substr(AD_BASE_CUT.BUILD_NO, '[^- ]+[0-9]', 1, 2), '[^0-9]','')AS INT);
...
AD_BASE_CUT.ADD_NUM, 
  AD_BASE_CUT.UPRN,
  AD_BASE_CUT.PARENT_UPRN,
  AD_BASE_CUT.ADDRESS_STRING_NOPC,
  AD_BASE_CUT.post_town,
  (length(TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)) 
 - UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2,TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)))/length(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2) as score1
FROM SECOND_A,AD_BASE_CUT
 WHERE SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2=AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2 
 AND AD_BASE_CUT.H3_6=SECOND_A.H3_6_p;
...
SECOND_A.ADDRESS_STRING, 
  AD_BASE_CUT.UPRN,
   AD_BASE_CUT.PARENT_UPRN,
  AD_BASE_CUT.ADDRESS_STRING_nopc,
  AD_BASE_CUT.DESCRIPTION,
 (length(TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)) 
 - UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2,TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)))/length(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2) as score1
FROM SECOND_A,AD_BASE_CUT
 WHERE 
 AD_BASE_CUT.H3_10=SECOND_A.H3_10_p 
  AND AD_BASE_CUT.ADD_NUM = SECOND_A.ADD_NUM
 AND instr(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.DESCRIPTION,1,1)>0
--AND instr(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ABBR_STREET1,1,1)>0
AND UTL_MATCH.JARO_WINKLER(SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2, AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2)>0.85;
...
AD_BASE_CUT.ADD_NUM, 
  ...
  AD_BASE_CUT.PARENT_UPRN,
  AD_BASE_CUT.ADDRESS_STRING_NOPC,
  (length(TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)) - UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2,TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)))
  /length(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2) as score1
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.h3_7=SECOND_A.H3_7_p 
AND AD_BASE_CUT.ADD_NUM IS NULL
AND SECOND_A.ADD_NUM IS NULL
AND LENGTH(SECOND_A.CURRENT_LINE1)>3
AND SOUNDEX(regexp_substr(SECOND_A.CURRENT_LINE1, '[A-Z ]+', 1, 1))=SOUNDEX(regexp_substr(AD_BASE_CUT.ADDRESS_LINE_1, '[A-Z ]+', 1, 1))
AND (length(TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)) - UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2,TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)))
  /length(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2)>0.88;
  --ADD SOUNDEX
...
AD_BASE_CUT.ADD_NUM, 
  AD_BASE_CUT.UPRN,
  AD_BASE_CUT.PARENT_UPRN,
  (length(TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)) - UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.POST_TOWN,TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)))
  /length(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.POST_TOWN) as score,
  AD_BASE_CUT.ADDRESS_STRING_NOPC
FROM SECOND_A,AD_BASE_CUT
 WHERE SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2=AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.POST_TOWN;
 
 UPDATE results3 SET STAGE= '3'; 
----
...
SECOND_A.ADD_NUM as in_num,AD_BASE_CUT.ADD_NUM,   AD_BASE_CUT.UPRN,  AD_BASE_CUT.PARENT_UPRN,
  AD_BASE_CUT.DESCRIPTION,  AD_BASE_CUT.ADDRESS_LINE_1,  AD_BASE_CUT.ADDRESS_LINE_2,  AD_BASE_CUT.POST_TOWN,
  AD_BASE_CUT.ADDRESS_STRING_NOPC,
    (length(TRIM(LEADING FROM SECOND_A.ADDRESS_STRING)) 
    - UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2||AD_BASE_CUT.POST_TOWN,TRIM(LEADING FROM SECOND_A.ADDRESS_STRING)))
  /length(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2||AD_BASE_CUT.POST_TOWN) as score
FROM SECOND_A,AD_BASE_CUT
WHERE SECOND_A.H3_8_P=AD_BASE_CUT.H3_8
AND AD_BASE_CUT.ADD_NUM = SECOND_A.ADD_NUM
AND (length(TRIM(LEADING FROM SECOND_A.ADDRESS_STRING)) - UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2||AD_BASE_CUT.POST_TOWN,TRIM(LEADING FROM SECOND_A.ADDRESS_STRING)))
  /length(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2||AD_BASE_CUT.POST_TOWN)>0.85
  AND (INSTR(SECOND_A.address_string ,AD_BASE_CUT.DESCRIPTION,1,1)>0 OR INSTR(SECOND_A.address_string ,AD_BASE_CUT.ABBR_STREET1,1,1)>0);
...
AD_BASE_CUT.PARENT_UPRN,
AD_BASE_CUT.ADDRESS_STRING_NOPC,
(length(TRIM(LEADING FROM SECOND_A.ADDRESS_STRING)) - UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_STRING_NOPC,
TRIM(LEADING FROM SECOND_A.ADDRESS_STRING)))/length(AD_BASE_CUT.ADDRESS_STRING_NOPC) AS SCORE1
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.H3_7=SECOND_A.H3_7_P
AND AD_BASE_CUT.ADD_NUM = SECOND_A.ADD_NUM 
AND INSTR(SECOND_A.CURRENT_LINE1 ,AD_BASE_CUT.description,1,1)>0;
...
SECOND_A.ADDRESS_STRING, 
  AD_BASE_CUT.UPRN,
  AD_BASE_CUT.PARENT_UPRN,
  (length(TRIM(LEADING FROM SECOND_A.ADDRESS_STRING)) - UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_STRING_NOPC,TRIM(LEADING FROM SECOND_A.ADDRESS_STRING)))
  /length(AD_BASE_CUT.ADDRESS_STRING_NOPC) as score,
  AD_BASE_CUT.ADDRESS_STRING_NOPC
  FROM SECOND_A,AD_BASE_CUT
 WHERE AD_BASE_CUT.H3_7=SECOND_A.H3_7_P
 AND INSTR(SECOND_A.address_string ,AD_BASE_CUT.DESCRIPTION,1,1)>0
...
SECOND_A.ADDRESS_STRING, 
  AD_BASE_CUT.UPRN,
  AD_BASE_CUT.PARENT_UPRN,
  UTL_MATCH.edit_distance_similarity( AD_BASE_CUT.ADDRESS_STRING_NOPC,TRIM(LEADING FROM SECOND_A.ADDRESS_STRING)) as score1,
  AD_BASE_CUT.ADDRESS_STRING_NOPC
  FROM SECOND_A,AD_BASE_CUT
 WHERE SECOND_A.H3_8_P=AD_BASE_CUT.H3_8
 AND (INSTR(SECOND_A.CURRENT_LINE1,AD_BASE_CUT.ABBR_STREET1,1,1)>0 OR INSTR(SECOND_A.CURRENT_LINE1,AD_BASE_CUT.DESCRIPTION,1,1)>0)
 AND (AD_BASE_CUT.BUILD_NO=second_A.add_num OR AD_BASE_CUT.BUILD_NO IS NULL AND AD_BASE_CUT.SUB_UNIT = SECOND_A.ADD_NUM);
...
--address string JW score diff is greater than 0.87 and AD_BASE_CUT buidlno is within incoming numerical elements.
...
SECOND_A.ADDRESS_STRING, 
  AD_BASE_CUT.UPRN,
  AD_BASE_CUT.PARENT_UPRN,
  (length(TRIM(LEADING FROM SECOND_A.ADDRESS_STRING)) - UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_STRING_NOPC,TRIM(LEADING FROM SECOND_A.ADDRESS_STRING)))/length(AD_BASE_CUT.ADDRESS_STRING_NOPC) AS SCORE1,
   AD_BASE_CUT.ADDRESS_STRING_NOPC
  FROM SECOND_A,AD_BASE_CUT
 WHERE AD_BASE_CUT.H3_7=SECOND_A.H3_7_p
 AND LENGTH(TRIM(SECOND_A.CURRENT_LINE1))<3
 and (length(TRIM(LEADING FROM SECOND_A.ADDRESS_STRING)) - UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_STRING_NOPC,TRIM(LEADING FROM SECOND_A.ADDRESS_STRING)))/length(AD_BASE_CUT.ADDRESS_STRING_NOPC) >0.87
  AND AD_BASE_CUT.BUILD_NO=second_A.BUILD_NO;
...
SECOND_A.ADDRESS_STRING, 
  AD_BASE_CUT.UPRN,
  AD_BASE_CUT.PARENT_UPRN,
  (length(TRIM(LEADING FROM SECOND_A.ADDRESS_STRING)) - UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_STRING_NOPC,TRIM(LEADING FROM SECOND_A.ADDRESS_STRING)))/length(AD_BASE_CUT.ADDRESS_STRING_NOPC)
  +
  (length(TRIM(LEADING FROM AD_BASE_CUT.ADDRESS_STRING_NOPC)) - UTL_MATCH.EDIT_DISTANCE(SECOND_A.ADDRESS_STRING,TRIM(LEADING FROM AD_BASE_CUT.ADDRESS_STRING_NOPC)))/length(SECOND_A.ADDRESS_STRING) AS SCORE1,
  AD_BASE_CUT.ADDRESS_STRING_NOPC
  FROM SECOND_A,AD_BASE_CUT
 WHERE SECOND_A.H3_7_P=AD_BASE_CUT.H3_7
  AND INSTR(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.DESCRIPTION,1,1)>0
  AND AD_BASE_CUT.BUILD_NO=SECOND_A.BUILD_NO
  and (length(TRIM(LEADING FROM SECOND_A.ADDRESS_STRING)) - UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_STRING_NOPC,TRIM(LEADING FROM SECOND_A.ADDRESS_STRING)))/length(AD_BASE_CUT.ADDRESS_STRING_NOPC) >0.87;
 --
...
drop table RESULTS9;
----------------------
--address is indexed to same H3_8 tile AD_BASE_CUT build_no = numerical elements form incoming lines 1 & 2 combined also contain the street desrciption from USRN.
----------------------
...
SECOND_A.ADD_NUM,
  ...
  AD_BASE_CUT.description,
  (length(TRIM(LEADING FROM SECOND_A.address_string)) - 
  UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_STRING_NOPC,TRIM(LEADING FROM SECOND_A.address_string)))/length(AD_BASE_CUT.ADDRESS_STRING_NOPC) AS SCORE1,
  AD_BASE_CUT.ADDRESS_STRING_NOPC
  FROM SECOND_A,AD_BASE_CUT
WHERE SECOND_A.H3_6_P=AD_BASE_CUT.H3_6
AND INSTR(AD_BASE_CUT.BUILD_NO,SECOND_A.BUILD_NO,1,1)>0
and LENGTH(AD_BASE_CUT.BUILD_NO)=LENGTH(SECOND_A.BUILD_NO)
AND INSTR(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ABBR_STREET1,1,1)>0;
...
AD_BASE_CUT.ADD_NUM, 
  ...
  TRIM(LEADING FROM SECOND_A.ADDRESS_STRING)))/length(AD_BASE_CUT.ADDRESS_STRING_NOPC) AS SCORE1
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.H3_6=SECOND_A.H3_6_P
AND AD_BASE_CUT.BUILD_NO = SECOND_A.ADD_NUM 
AND INSTR(SECOND_A.CURRENT_LINE1 ,AD_BASE_CUT.DESCRIPTION,1,1)>0;
...
WHERE AD_BASE_CUT.H3_7=SECOND_A.H3_7_P
AND (AD_BASE_CUT.add_num= SECOND_A.ADD_NUM )
AND (INSTR(SECOND_A.CURRENT_LINE2 ,AD_BASE_CUT.DESCRIPTION,1,1)>0 or INSTR(SECOND_A.CURRENT_LINE2 ,AD_BASE_CUT.ABBR_STREET1,1,1)>0);
--
...
WHERE AD_BASE_CUT.H3_7=SECOND_A.H3_7_P
AND(AD_BASE_CUT.BUILD_NO = SECOND_A.ADD_NUM )
AND INSTR(SECOND_A.CURRENT_LINE1 ,AD_BASE_CUT.ABBR_STREET1,1,1)>0;
...
WHERE AD_BASE_CUT.H3_7=SECOND_A.H3_7_P
AND (AD_BASE_CUT.ADD_NUM = SECOND_A.ADD_NUM )
AND INSTR(SECOND_A.CURRENT_LINE2 ,AD_BASE_CUT.ABBR_STREET1,1,1)>0;
...
AD_BASE_CUT.PARENT_UPRN,
AD_BASE_CUT.ADDRESS_STRING_NOPC,
(length(TRIM(LEADING FROM SECOND_A.CURRENT_LINE1)) - UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.DESCRIPTION,TRIM(LEADING FROM SECOND_A.CURRENT_LINE1)))/length(AD_BASE_CUT.DESCRIPTION) AS SCORE1,
(length(TRIM(LEADING FROM SECOND_A.CURRENT_LINE2)) - UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.DESCRIPTION,TRIM(LEADING FROM SECOND_A.CURRENT_LINE2)))/length(AD_BASE_CUT.DESCRIPTION) AS SCORE2
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.H3_8=SECOND_A.H3_8_P
AND AD_BASE_CUT.ADD_NUM = SECOND_A.ADD_NUM 
and UTL_MATCH.JARO_WINKLER(replace (SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2, ' ', ''),replace(AD_BASE_CUT.address_line_1||AD_BASE_CUT.address_line_2, ' ', ''))>0.8
AND (INSTR(SECOND_A.CURRENT_LINE2,AD_BASE_CUT.DESCRIPTION, 1, 1)>0 OR INSTR(SECOND_A.CURRENT_LINE2,AD_BASE_CUT.ABBR_STREET1, 1, 1)>0
OR INSTR(SECOND_A.CURRENT_LINE1,AD_BASE_CUT.DESCRIPTION, 1, 1)>0 OR INSTR(SECOND_A.CURRENT_LINE1,AD_BASE_CUT.ABBR_STREET1, 1, 1)>0);
...
AD_BASE_CUT.PARENT_UPRN,
AD_BASE_CUT.ADDRESS_STRING_NOPC,
AD_BASE_CUT.ADDRESS_LINE_1,
AD_BASE_CUT.ADDRESS_LINE_2,
AD_BASE_CUT.POST_TOWN,
AD_BASE_CUT.TOWN,
AD_BASE_CUT.LOCALITY,
(length(SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)) - UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2,SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)/length(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2) AS SCORE1
FROM SECOND_A,AD_BASE_CUT
WHERE SECOND_A.H3_7_P =AD_BASE_CUT.H3_7
AND AD_BASE_CUT.ADD_NUM = SECOND_A.ADD_NUM 
AND (INSTR(SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2,AD_BASE_CUT.ABBR_STREET1, 1, 1)>0 or INSTR(SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2,AD_BASE_CUT.description, 1, 1)>0  )
AND INSTR(SECOND_A.ADDRESS_STRING, AD_BASE_CUT.POST_TOWN, 1, 1)>0
and (length( SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2) - UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2,SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2))
/length(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2)<0.87;
--AND SOUNDEX(regexp_substr(SECOND_A.CURRENT_LINE2, '[A-Z ]+', 1, 1)) = SOUNDEX(regexp_substr(AD_BASE_CUT.DESCRIPTION, '[A-Z ]+', 1, 1));
-------------------
...
AD_BASE_CUT.PARENT_UPRN,
AD_BASE_CUT.ADDRESS_STRING_NOPC,
(length(TRIM(LEADING FROM SECOND_A.ADDRESS_STRING)) - UTL_MATCH.EDIT_DISTANCE(regexp_replace(AD_BASE_CUT.ADDRESS_STRING_NOPC,'BLOCK|FLAT|FLOOR FLAT',''),TRIM(LEADING FROM SECOND_A.ADDRESS_STRING))) / LENGTH(regexp_replace(AD_BASE_CUT.ADDRESS_STRING_NOPC,'BLOCK|FLAT|FLOOR FLAT','')) AS SCORE1
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.H3_7=SECOND_A.H3_7_P
AND AD_BASE_CUT.ADD_NUM = SECOND_A.ADD_NUM
AND( INSTR(SECOND_A.CURRENT_LINE2 ,AD_BASE_CUT.ABBR_STREET1,1,1)>0 OR INSTR(SECOND_A.CURRENT_LINE1 ,AD_BASE_CUT.ABBR_STREET1,1,1)>0)
--OR  INSTR(SECOND_A.CURRENT_LINE2 ,AD_BASE_CUT.DESCRIPTION,1,1)>0 OR INSTR(SECOND_A.CURRENT_LINE1 ,AD_BASE_CUT.DESCRIPTION,1,1)>0)
and instr(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.post_town,1,1)>0;
...
WHERE AD_BASE_CUT.H3_7=SECOND_A.H3_7_P
AND AD_BASE_CUT.ADD_NUM = SECOND_A.ADD_NUM
AND( INSTR(SECOND_A.CURRENT_LINE2 ,AD_BASE_CUT.DESCRIPTION,1,1)>0 OR INSTR(SECOND_A.CURRENT_LINE1 ,AD_BASE_CUT.DESCRIPTION,1,1)>0)
and instr(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.post_town,1,1)>0;
...
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.H3_8=SECOND_A.H3_8_P
AND  SECOND_A.ADD_NO_SPACE = REPLACE(AD_BASE_CUT.ADDRESS_STRING_NOPC,' ','');
--------------------
...
AD_BASE_CUT.ADDRESS_STRING_NOPC,
(length(TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)) - 
UTL_MATCH.EDIT_DISTANCE(regexp_replace(AD_BASE_CUT.ADDRESS_LINE_1,'UNIT|BLOCK|BLK|FLAT|FL|FLOOR|RM|ROOM|FLAT','')||AD_BASE_CUT.ADDRESS_LINE_2
,TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)))/
length(regexp_replace(AD_BASE_CUT.ADDRESS_LINE_1,'UNIT|BLOCK|BLK|FLAT|FL|RM|ROOM|FLOOR|FLAT','')||AD_BASE_CUT.ADDRESS_LINE_2) AS SCORE1
FROM SECOND_A,AD_BASE_CUT
 WHERE AD_BASE_CUT.H3_7=SECOND_A.H3_7_P
AND INSTR(SECOND_A.ADDRESS_STRING ,AD_BASE_CUT.ABBR_STREET1,1,1)>0
AND INSTR(SECOND_A.ADDRESS_STRING ,AD_BASE_CUT.POST_TOWN,1,1)>0
AND SECOND_A.add_num=AD_BASE_CUT.add_num;
...
AD_BASE_CUT.ADD_NUM, 
  ...
  AD_BASE_CUT.PARENT_UPRN,
  AD_BASE_CUT.ADDRESS_STRING_NOPC,
  (length(TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)) - UTL_MATCH.EDIT_DISTANCE(regexp_replace(AD_BASE_CUT.ADDRESS_LINE_1,'UNIT|BLOCK|BLK|FLAT|FL|FLOOR|RM|ROOM|FLAT','')||AD_BASE_CUT.ADDRESS_LINE_2
  ,TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)))/length(regexp_replace(AD_BASE_CUT.ADDRESS_LINE_1,'UNIT|BLOCK|BLK|FLAT|FL|RM|ROOM|FLOOR|FLAT','')||AD_BASE_CUT.ADDRESS_LINE_2) AS SCORE1
FROM SECOND_A,AD_BASE_CUT
 WHERE AD_BASE_CUT.H3_7=SECOND_A.H3_7_P
 AND  INSTR(SECOND_A.CURRENT_LINE2 ,AD_BASE_CUT.DESCRIPTION,1,1)>0
AND SECOND_A.CURRENT_LINE3=AD_BASE_CUT.POST_TOWN
AND SECOND_A.add_num=AD_BASE_CUT.add_num ;
------------
...
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.H3_8=SECOND_A.H3_8_P
and AD_BASE_CUT.ABBR_STREET1 is not null
AND  INSTR(SECOND_A.CURRENT_LINE2 ,AD_BASE_CUT.ABBR_STREET1,1,1)>0
AND SECOND_A.CURRENT_LINE3=AD_BASE_CUT.POST_TOWN
AND SECOND_A.BUILD_NO = AD_BASE_CUT.BUILD_NO;
...
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.H3_7=SECOND_A.H3_7_P
--and AD_BASE_CUT.ABBR_STREET1is not null
AND SECOND_A.add_NUM = AD_BASE_CUT.sub_unit
AND  (INSTR(SECOND_A.ADDRESS_STRING ,AD_BASE_CUT.ABBR_STREET1,1,1)>0 or INSTR(SECOND_A.ADDRESS_STRING ,AD_BASE_CUT.description,1,1)>0);

UPDATE RESULTS24 SET STAGE= '24';
--OR SECOND_A.ADD_NUM = AD_BASE_CUT.ADD_NUM);
---------------------------------------
...
AD_BASE_CUT.description,
AD_BASE_CUT.ADDRESS_STRING_NOPC,
AD_BASE_CUT.BUILD_NO,
AD_BASE_CUT.SUB_UNIT,
(length(TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)) - 
UTL_MATCH.EDIT_DISTANCE(regexp_replace(AD_BASE_CUT.ADDRESS_LINE_1,'UNIT|BLOCK|BLK|FLAT|FL|FLOOR|RM|ROOM|FLAT','')||AD_BASE_CUT.ADDRESS_LINE_2
,TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)))/
length(regexp_replace(AD_BASE_CUT.ADDRESS_LINE_1,'UNIT|BLOCK|BLK|FLAT|FL|RM|ROOM|FLOOR|FLAT','')||AD_BASE_CUT.ADDRESS_LINE_2) AS SCORE1
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.H3_7=SECOND_A.H3_7_P
and AD_BASE_CUT.DESCRIPTION is not null
AND  (INSTR(SECOND_A.CURRENT_LINE1 ,AD_BASE_CUT.DESCRIPTION,1,1)>0 or INSTR(SECOND_A.CURRENT_LINE1 ,AD_BASE_CUT.ABBR_STREET1,1,1)>0 )
AND INSTR(SECOND_A.ADDRESS_STRING ,AD_BASE_CUT.BUILD_NO,1,1)>0
AND INSTR(SECOND_A.ADDRESS_STRING ,AD_BASE_CUT.SUB_UNIT,1,1)>0
and (length(TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)) - 
UTL_MATCH.EDIT_DISTANCE(regexp_replace(AD_BASE_CUT.ADDRESS_LINE_1,'UNIT|BLOCK|BLK|FLAT|FL|FLOOR|RM|ROOM|FLAT','')||AD_BASE_CUT.ADDRESS_LINE_2
,TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)))/
length(regexp_replace(AD_BASE_CUT.ADDRESS_LINE_1,'UNIT|BLOCK|BLK|FLAT|FL|RM|ROOM|FLOOR|FLAT','')||AD_BASE_CUT.ADDRESS_LINE_2)>0.75;
...
and AD_BASE_CUT.DESCRIPTION is not null
AND  (INSTR(SECOND_A.CURRENT_LINE1 ,AD_BASE_CUT.DESCRIPTION,1,1)>0 or INSTR(SECOND_A.CURRENT_LINE1 ,AD_BASE_CUT.ABBR_STREET1,1,1)>0
OR INSTR(SECOND_A.CURRENT_LINE2 ,AD_BASE_CUT.DESCRIPTION,1,1)>0 or INSTR(SECOND_A.CURRENT_LINE2 ,AD_BASE_CUT.ABBR_STREET1,1,1)>0)
AND SECOND_A.BUILD_NO = AD_BASE_CUT.BUILD_NO;
---------------------------------------
...
AND SECOND_A.SUB_UNIT = AD_BASE_CUT.BUILD_NO;
...
SECOND_A.ADDRESS_STRING, 
  ...
  PARENT_UPRN,
  (length(TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)) - 
  UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2,
  TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)))
  /length(AD_BASE_CUT.ADDRESS_STRING_NOPC) as score1,
  AD_BASE_CUT.ADDRESS_STRING_NOPC
  FROM SECOND_A,AD_BASE_CUT
 WHERE AD_BASE_CUT.H3_6=SECOND_A.H3_6_P
 AND INSTR(SECOND_A.CURRENT_LINE1 ,AD_BASE_CUT.ABBR_STREET1,1,1)>0
 AND INSTR(SECOND_A.CURRENT_LINE2 ,AD_BASE_CUT.TOWN,1,1)>0
  AND AD_BASE_CUT.ADD_NUM = SECOND_A.ADD_NUM;
...
SECOND_A.ADDRESS_STRING, 
  AD_BASE_CUT.UPRN,
  PARENT_UPRN,
  (length(TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)) - UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2,TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)))
  /length(AD_BASE_CUT.ADDRESS_STRING_NOPC) as score,
  AD_BASE_CUT.ADDRESS_STRING_NOPC
  FROM SECOND_A,AD_BASE_CUT
 WHERE AD_BASE_CUT.H3_6=SECOND_A.H3_6_P
 AND INSTR(SECOND_A.CURRENT_LINE1 ,AD_BASE_CUT.ABBR_STREET1,1,1)>0
 AND INSTR(SECOND_A.CURRENT_LINE2 ,AD_BASE_CUT.TOWN,1,1)>0
  AND AD_BASE_CUT.BUILD_NO = SECOND_A.SUB_UNIT
  AND SECOND_A.BUILD_NO IS NULL;
...
SECOND_A.CURRENT_LINE2,
  ...
  AD_BASE_CUT.PARENT_UPRN,
  AD_BASE_CUT.ADDRESS_LINE_2,
  (length(TRIM(SECOND_A.SUB_UNIT||' '|| SECOND_A.CURRENT_LINE2)) - SYS.UTL_MATCH.JARO_WINKLER_SIMILARITY(AD_BASE_CUT.ADD_NUM|| ' '||AD_BASE_CUT.ABBR_STREET1,TRIM(SECOND_A.SUB_UNIT||' '|| SECOND_A.CURRENT_LINE2)))
  /length(AD_BASE_CUT.ADD_NUM|| ' '||AD_BASE_CUT.ABBR_STREET1) as score,
  AD_BASE_CUT.ADDRESS_STRING_NOPC
  FROM SECOND_A,AD_BASE_CUT
 WHERE AD_BASE_CUT.H3_7=SECOND_A.H3_7_P
and regexp_replace(regexp_replace(SECOND_A.CURRENT_LINE2,'[A-Z]',''),'[[:space:]]{2,}', '')=AD_BASE_CUT.SUB_UNIT 
AND AD_BASE_CUT.BUILD_NO IS NULL
--and AD_BASE_CUT.ABBR_STREET1is not null
...
SECOND_A.CURRENT_LINE1,
  ...
  - SYS.UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADD_NUM|| ' '||AD_BASE_CUT.ABBR_STREET1,TRIM(SECOND_A.CURRENT_LINE1)))
  /length(AD_BASE_CUT.ADD_NUM|| ' '||AD_BASE_CUT.ABBR_STREET1) as score,
  AD_BASE_CUT.ADDRESS_STRING_NOPC
  FROM SECOND_A,AD_BASE_CUT
 WHERE AD_BASE_CUT.H3_7=SECOND_A.H3_7_P
and regexp_replace(TRIM(regexp_replace(SECOND_A.CURRENT_LINE1,'[A-Z]','')),'[[:space:]]{2,}', '')=AD_BASE_CUT.SUB_UNIT --problem here for alpha numbers
AND AD_BASE_CUT.BUILD_NO IS NULL
...
SECOND_A.CURRENT_LINE1,
  ...
  FROM SECOND_A,AD_BASE_CUT
 WHERE AD_BASE_CUT.H3_7=SECOND_A.H3_7_P
and regexp_replace(TRIM(regexp_replace(SECOND_A.CURRENT_LINE1,'[A-Z]','')),'[[:space:]]{2,}', '')=AD_BASE_CUT.SUB_UNIT --problem for alpha characters here
AND AD_BASE_CUT.BUILD_NO IS NULL
AND LENGTH(SECOND_A.CURRENT_LINE1)>4
--NEEDS WORK ON SCORING AND TO ENSURE LINE 2 IS SIMILAR
 AND INSTR(SECOND_A.CURRENT_LINE1,AD_BASE_CUT.DESCRIPTION ,1,1)>0 ;
...
SECOND_A.CURRENT_LINE1,
  ...
  AD_BASE_CUT.ADDRESS_LINE_1,
  (length(TRIM(SECOND_A.CURRENT_LINE1)) 
  - SYS.UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1|| ' '||AD_BASE_CUT.ADDRESS_LINE_2,TRIM(SECOND_A.CURRENT_LINE1)))
  /length(AD_BASE_CUT.ADDRESS_LINE_1|| ' '||AD_BASE_CUT.ADDRESS_LINE_2) as score,
  AD_BASE_CUT.ADDRESS_STRING_NOPC
  FROM SECOND_A,AD_BASE_CUT
 WHERE AD_BASE_CUT.H3_7=SECOND_A.H3_7_P
and regexp_replace(TRIM(regexp_replace(SECOND_A.CURRENT_LINE1,'[A-Z]','')),'[[:space:]]{2,}', '')=AD_BASE_CUT.SUB_UNIT
AND AD_BASE_CUT.BUILD_NO IS NULL
--NEEDS WORK ON SCORING AND TO ENSURE LINE 2 IS SIMILAR
 AND (INSTR(SECOND_A.CURRENT_LINE1,AD_BASE_CUT.ABBR_STREET1,1,1)>0 OR INSTR(SECOND_A.CURRENT_LINE1,AD_BASE_CUT.DESCRIPTION ,1,1)>0);
 ------------------
...
SECOND_A.CURRENT_LINE1,
  ...
  AD_BASE_CUT.ADDRESS_LINE_1,
  (length(TRIM(SECOND_A.CURRENT_LINE1)) 
  - SYS.UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1|| ' '||AD_BASE_CUT.ADDRESS_LINE_2,TRIM(SECOND_A.CURRENT_LINE2)))
  /length(AD_BASE_CUT.ADDRESS_LINE_1|| ' '||AD_BASE_CUT.ADDRESS_LINE_2) as score,
  AD_BASE_CUT.ADDRESS_STRING_NOPC
  FROM SECOND_A,AD_BASE_CUT
 WHERE AD_BASE_CUT.H3_7=SECOND_A.H3_7_P
and regexp_replace(TRIM(regexp_replace(SECOND_A.CURRENT_LINE2,'[A-Z]','')),'[[:space:]]{2,}', '')=AD_BASE_CUT.SUB_UNIT
AND AD_BASE_CUT.BUILD_NO IS NULL
--NEEDS WORK ON SCORING AND TO ENSURE LINE 2 IS SIMILAR
 AND (INSTR(SECOND_A.CURRENT_LINE2,AD_BASE_CUT.ABBR_STREET1,1,1)>0 OR INSTR(SECOND_A.CURRENT_LINE2,AD_BASE_CUT.DESCRIPTION ,1,1)>0) ;
...
AND AD_BASE_CUT.BUILD_NO IS NULL
and length(SECOND_A.CURRENT_LINE1)>4
and length(AD_BASE_CUT.ADDRESS_LINE_1)>4
--NEEDS WORK ON SCORING AND TO ENSURE LINE 2 IS SIMILAR
 AND (INSTR(SECOND_A.CURRENT_LINE1,AD_BASE_CUT.sub_unit||' '||AD_BASE_CUT.ABBR_STREET1,1,1)>0 OR INSTR(SECOND_A.CURRENT_LINE1,AD_BASE_CUT.sub_unit|| ' ' ||AD_BASE_CUT.DESCRIPTION ,1,1)>0) 
 and  (length(TRIM(SECOND_A.CURRENT_LINE1)) 
  - SYS.UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1|| ' '||AD_BASE_CUT.ADDRESS_LINE_2,TRIM(SECOND_A.CURRENT_LINE1)))
  /length(AD_BASE_CUT.ADDRESS_LINE_1|| ' '||AD_BASE_CUT.ADDRESS_LINE_2)>0.3;
...
--AD_BASE_CUT.PARENT_UPRN,
  --AD_BASE_CUT.ADDRESS_LINE_1,
 -- (length(TRIM(SECOND_A.CURRENT_LINE1)) 
  -- - SYS.UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1|| ' '||AD_BASE_CUT.ADDRESS_LINE_2,TRIM(SECOND_A.CURRENT_LINE1||' '||SECOND_A.CURRENT_LINE2)))
  --/length(AD_BASE_CUT.ADDRESS_LINE_1|| ' '||AD_BASE_CUT.ADDRESS_LINE_2) as score,
  --AD_BASE_CUT.ADDRESS_STRING_NOPC
  --FROM SECOND_A,AD_BASE_CUT
 --WHERE AD_BASE_CUT.H3_8=SECOND_A.H3_8_P
----AND INSTR(AD_BASE_CUT.ADDRESS_STRING_NOPC,SECOND_A.ADD_STRING_WORKING,1,1)>0
 --AND INSTR(AD_BASE_CUT.ADD_NUM,SECOND_A.BUILD_NO,1,1)>0;
----NEEDS WORK ON SCORING AND TO ENSURE LINE 2 IS SIMILAR
 ----AND TO_NUMBER(SECOND_A.BUILD_NUM) BETWEEN TO_NUMBER(AD_BASE_CUT.LOWER) AND TO_NUMBER(AD_BASE_CUT.UPPER)
 ----and AD_BASE_CUT.word_three=second_a.word_three
 --and   (length(TRIM(SECOND_A.CURRENT_LINE1)) 
  -- - SYS.UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1|| ' '||AD_BASE_CUT.ADDRESS_LINE_2,TRIM(SECOND_A.CURRENT_LINE1||' '||SECOND_A.CURRENT_LINE2)))
  --/length(AD_BASE_CUT.ADDRESS_LINE_1|| ' '||AD_BASE_CUT.ADDRESS_LINE_2)>0.3;
...
SECOND_A.CURRENT_LINE1,
  ...
  - SYS.UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1|| ' '||AD_BASE_CUT.ADDRESS_LINE_2,TRIM(SECOND_A.ADD_NUM||' '||SECOND_A.CURRENT_LINE2)))
  /length(AD_BASE_CUT.ADDRESS_LINE_1|| ' '||AD_BASE_CUT.ADDRESS_LINE_2) as score,
  AD_BASE_CUT.ADDRESS_STRING_NOPC
  FROM SECOND_A,AD_BASE_CUT
 WHERE AD_BASE_CUT.H3_7=SECOND_A.H3_7_P
AND regexp_replace(SECOND_A.ADD_NUM,'[[:space:]]{2,}', '')=regexp_replace(AD_BASE_CUT.ADDRESS_LINE_1,'[[:space:]]{2,}', '')
AND regexp_replace(SECOND_A.CURRENT_LINE2,'[[:space:]]{2,}', '')=regexp_replace(AD_BASE_CUT.ADDRESS_LINE_2,'[[:space:]]{2,}', '');
-----------------------
...
AD_BASE_CUT.ADD_NUM, 
  ...
  UTL_MATCH.jaro_winkler(AD_BASE_CUT.ADDRESS_line_1,TRIM(LEADING FROM SECOND_A.current_line1)))
  /length(AD_BASE_CUT.ADDRESS_line_1) as score1,
  (length(TRIM(LEADING FROM SECOND_A.current_line1)) - 
  UTL_MATCH.jaro_winkler(AD_BASE_CUT.ADDRESS_line_2,TRIM(LEADING FROM SECOND_A.current_line2)))
  /length(AD_BASE_CUT.ADDRESS_line_2) as score2
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.h3_7=SECOND_A.H3_7_p 
and AD_BASE_CUT.add_num is null and second_a.add_num is null
--AND INSTR(AD_BASE_CUT.ADD_NUM,SECOND_A.ADD_NUM,1,1)>0
AND INSTR(AD_BASE_CUT.ADDRESS_STRING_NOPC,second_a.WORD_ONE||' '||second_a.WORD_TWO,1,1)>0
--OR INSTR(AD_BASE_CUT.ADDRESS_STRING_NOPC,second_a.WORD_TWO||' '||second_a.WORD_THREE,1,1)>0 
--OR INSTR(AD_BASE_CUT.ADDRESS_STRING_NOPC,second_a.WORD_THREE||' '||second_a.WORD_FOUR,1,1)>0
--OR INSTR(AD_BASE_CUT.ADDRESS_STRING_NOPC,second_a.WORD_FOUR||' '||second_a.WORD_FIVE,1,1)>0)
AND (INSTR(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.DESCRIPTION,1,1)>0 or instr(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ABBR_STREET1,1,1)>0);
...
AD_BASE_CUT.ADD_NUM, 
  ...
  AD_BASE_CUT.ADDRESS_STRING_NOPC,
  (length(TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)) - 
  UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2,TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)))
  /length(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2) as score1
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.h3_7=SECOND_A.H3_7_p 
and length(SECOND_A.CURRENT_LINE1)>3
AND (SECOND_A.add_num=AD_BASE_CUT.add_num or SECOND_A.add_num is null and AD_BASE_CUT.add_num is null)
AND INSTR(AD_BASE_CUT.ADDRESS_STRING_NOPC,SECOND_A.CURRENT_LINE1,1,1)>0 ;
...
WHERE AD_BASE_CUT.h3_6=SECOND_A.H3_6_p 
and length(SECOND_A.CURRENT_LINE1)>3
AND SECOND_A.BUILD_NO IS NULL AND SECOND_A.SUB_UNIT=AD_BASE_CUT.ADD_NUM
AND INSTR(AD_BASE_CUT.ADDRESS_STRING_NOPC,SECOND_A.CURRENT_LINE1,1,1)>0 ;
-------------
...
WHERE AD_BASE_CUT.h3_8=SECOND_A.H3_8_p 
and length(SECOND_A.CURRENT_LINE1)>3
AND replace(AD_BASE_CUT.ADDRESS_LINE_1,' ','') =REPLACE(CURRENT_LINE1,' ','') 
AND (SECOND_A.ADD_NUM IS NULL OR (SECOND_A.ADD_NUM = AD_BASE_CUT.SUB_UNIT AND AD_BASE_CUT.BUILD_NO IS NULL));
-------------
...
WHERE AD_BASE_CUT.h3_7=SECOND_A.H3_7_p 
and length(SECOND_A.CURRENT_LINE1)>3
AND replace(AD_BASE_CUT.ADDRESS_LINE_1,' ','') =REPLACE(CURRENT_LINE2,' ','') 
AND (SECOND_A.ADD_NUM IS NULL OR (SECOND_A.ADD_NUM = AD_BASE_CUT.SUB_UNIT AND AD_BASE_CUT.BUILD_NO IS NULL) OR SECOND_A.ADD_NUM = AD_BASE_CUT.ADD_NUM );
...
WHERE AD_BASE_CUT.h3_6=SECOND_A.H3_6_p 
--and length(SECOND_A.CURRENT_LINE1)>3
AND replace(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_3,' ','') =REPLACE(CURRENT_LINE1||CURRENT_LINE2,' ','') 
AND (SECOND_A.ADD_NUM IS NULL OR (SECOND_A.ADD_NUM = AD_BASE_CUT.SUB_UNIT AND AD_BASE_CUT.BUILD_NO IS NULL) OR SECOND_A.ADD_NUM = AD_BASE_CUT.ADD_NUM );
...
WHERE AD_BASE_CUT.h3_8=SECOND_A.H3_8_p 
and length(SECOND_A.CURRENT_LINE1)>3
AND replace(AD_BASE_CUT.ADDRESS_LINE_2,' ','') =REPLACE(CURRENT_LINE1,' ','') 
AND (SECOND_A.ADD_NUM IS NULL OR (SECOND_A.ADD_NUM = AD_BASE_CUT.SUB_UNIT AND AD_BASE_CUT.BUILD_NO IS NULL));
...
AD_BASE_CUT.PARENT_UPRN,
AD_BASE_CUT.ADDRESS_STRING_NOPC,
(length(regexp_replace(AD_BASE_CUT.ADDRESS_STRING_NOPC,'[[:space:]]|,|[.]', '')) - SYS.UTL_MATCH.JARO_WINKLER(regexp_replace(AD_BASE_CUT.ADDRESS_STRING_NOPC,'[[:space:]]|,|[.]', ''),
regexp_replace(SECOND_A.ADDRESS_STRING,'[[:space:]]|,|[.]', '')))  /length(regexp_replace(SECOND_A.ADDRESS_STRING,'[[:space:]]|,|[.]', '')) as score1
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.h3_8=SECOND_A.H3_8_p 
 AND ((LENGTH(SECOND_A.WORD_ONE)>3 AND LENGTH(SECOND_A.WORD_ONE)<30 AND INSTR(AD_BASE_CUT.ADDRESS_STRING_NOPC,SECOND_A.WORD_ONE,1,1)>0 )
 OR(INSTR(AD_BASE_CUT.ADDRESS_STRING_NOPC,SECOND_A.WORD_ONE,1,1)>0 AND INSTR(AD_BASE_CUT.ADDRESS_STRING_NOPC,SECOND_A.WORD_TWO,1,1)>0))
and( second_a.add_num=AD_BASE_CUT.add_num or (second_a.add_num is null and AD_BASE_CUT.add_num is null));
...
regexp_replace(AD_BASE_CUT.address_string_nopc,'[[:space:]]|,|[.]', '')))  /length(regexp_replace(AD_BASE_CUT.address_string_nopc,'[[:space:]]|,|[.]', '')) as score1
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.h3_8=SECOND_A.H3_8_p 
 AND INSTR(AD_BASE_CUT.ADDRESS_STRING_NOPC,SECOND_A.WORD_one,1,1)>0 
 AND INSTR(AD_BASE_CUT.ADDRESS_STRING_NOPC,SECOND_A.WORD_TWO,1,1)>0
AND AD_BASE_CUT.add_num IS NULL AND second_a.add_num IS NULL
AND (INSTR(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ABBR_STREET1,1,1)>0 
OR INSTR(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.DESCRIPTION,1,1)>0);--CONSIDER REVERSING INSTR SEARCH AS A WAY TO AVOID HIGH CRESENT NORTH MATCHING HIGH CRESCENT19-08-22
...
SYS.UTL_MATCH.JARO_WINKLER(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.address_string_nopc))  /length(AD_BASE_CUT.address_string_nopc) as score1
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.h3_8=SECOND_A.H3_8_p 
--AND (length(regexp_replace(AD_BASE_CUT.ADDRESS_STRING_NOPC,'[[:space:]]|,|.', '')) - SYS.UTL_MATCH.JARO_WINKLER(regexp_replace(AD_BASE_CUT.ADDRESS_STRING_NOPC,'[[:space:]]|,|.', ''),
--regexp_replace(SECOND_A.ADDRESS_STRING,'[[:space:]]|,|.', '')))  /length(regexp_replace(SECOND_A.ADDRESS_STRING,'[[:space:]]|,|.', ''))>0.6
 AND ((LENGTH(SECOND_A.WORD_ONE)>3 AND INSTR(AD_BASE_CUT.ADDRESS_STRING_NOPC,SECOND_A.WORD_ONE,1,1)>0 )OR(INSTR(AD_BASE_CUT.ADDRESS_STRING_NOPC,SECOND_A.WORD_two,1,1)>0 
 AND INSTR(AD_BASE_CUT.ADDRESS_STRING_NOPC,SECOND_A.WORD_TWO,1,1)>0)OR(INSTR(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.WORD_ONE,1,1)>0 ))
and (SECOND_A.add_num=AD_BASE_CUT.sub_unit and AD_BASE_CUT.build_no is null)
--((INSTR(second_a.SUB_UNIT,AD_BASE_CUT.SUB_UNIT,1,1)>0 AND AD_BASE_CUT.BUILD_NO IS NULL AND SECOND_A.BUILD_NO IS NULL) 
--OR (INSTR(AD_BASE_CUT.add_num,second_a.SUB_UNIT,1,1)>0 AND SECOND_A.BUILD_NO IS NULL AND SECOND_A.BUILD_NO IS NULL)
--AND(CONVERT(second_a.SUB_UNIT,INTEGER)- CONVERT(AD_BASE_CUT.SUB_UNIT,INTEGER)=0 AND AD_BASE_CUT.BUILD_NO IS NULL AND SECOND_A.BUILD_NO IS NULL

--AND (AD_BASE_CUT.add_num IS NULL AND second_a.add_num IS NULL)  
--AND INSTR(second_a.add_num,AD_BASE_CUT.add_num,1,1)>0
AND (INSTR(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ABBR_STREET1,1,1)>0 OR INSTR(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.DESCRIPTION,1,1)>0);
--AND (INSTR(replace(SECOND_A.ADDRESS_STRING,' ',''),replace(AD_BASE_CUT.DESCRIPTION,' ',''),1,1)>0 or instr(replace(SECOND_A.ADDRESS_STRING,' ',''),replace(AD_BASE_CUT.ABBR_STREET1,' ',''),1,1)>0);
...
WHERE AD_BASE_CUT.h3_8=SECOND_A.H3_8_p 
 AND ((LENGTH(SECOND_A.WORD_ONE)>3 AND INSTR(AD_BASE_CUT.ADDRESS_STRING_NOPC,SECOND_A.WORD_ONE,1,1)>0 )OR(INSTR(AD_BASE_CUT.ADDRESS_STRING_NOPC,SECOND_A.WORD_two,1,1)>0 
 AND INSTR(AD_BASE_CUT.ADDRESS_STRING_NOPC,SECOND_A.WORD_TWO,1,1)>0)OR(INSTR(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.WORD_ONE,1,1)>0 ))
and (regexp_replace(second_a.add_num,'[[:space:]]|,|[.]', '')=regexp_replace(AD_BASE_CUT.add_num,'[[:space:]]|,|[.]', '')
or (regexp_replace(second_a.SUB_UNIT,'[[:space:]]|,|[.]', '')=regexp_replace(AD_BASE_CUT.SUB_UNIT,'[[:space:]]|,|[.]', '') AND AD_BASE_CUT.BUILD_NO IS NULL AND SECOND_A.BUILD_NO IS NULL)) 
AND (INSTR(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ABBR_STREET1,1,1)>0 OR INSTR(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.DESCRIPTION,1,1)>0);
...
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.h3_6=SECOND_A.H3_6_p 
 AND ((LENGTH(SECOND_A.WORD_ONE)>3 AND INSTR(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.WORD_ONE,1,1)>0 )and(INSTR(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.WORD_two,1,1)>0 ))
and( second_a.add_num=AD_BASE_CUT.add_num or (second_a.add_num is null and AD_BASE_CUT.add_num is null) or regexp_replace(AD_BASE_CUT.ADD_num,'[[:space:]]|,|[.]', '')=regexp_replace(second_a.ADD_num,'[[:space:]]|,|[.]', ''))
AND (INSTR(replace(SECOND_A.ADDRESS_STRING,' ',''),replace(AD_BASE_CUT.DESCRIPTION,' ',''),1,1)>0 or INSTR(replace(SECOND_A.ADDRESS_STRING,' ',''),replace(AD_BASE_CUT.ABBR_STREET1,' ',''),1,1)>0);
...
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.h3_6=SECOND_A.H3_6_p 
and((second_a.sub_unit is not null and second_a.build_no is null) and (AD_BASE_CUT.ADD_NUM = SECOND_A.SUB_UNIT))
AND (INSTR(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.description,1,1)>0 
or instr(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ABBR_STREET1,1,1)>0)
and instr(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.post_town ,1,1)>0;
...
or ((second_a.sub_unit is not null and second_a.build_no is null) and (AD_BASE_CUT.ADD_NUM = SECOND_A.SUB_UNIT)))
AND (INSTR(replace(SECOND_A.ADDRESS_STRING,' ',''),replace(AD_BASE_CUT.DESCRIPTION,' ',''),1,1)>0 or INSTR(replace(SECOND_A.ADDRESS_STRING,' ',''),replace(AD_BASE_CUT.ABBR_STREET1,' ',''),1,1)>0);
------
...
AD_BASE_CUT.WORD_ONE,
  ...
  UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2,TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2)))
  /length(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2) as score1,
  UTL_MATCH.jaro_winkler(TRIM(regexp_REPLACE(second_a.ADDRESS_STRING, '+[0-9]','') ),AD_BASE_CUT.ABBR_STREET1) as str_score
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.h3_8=SECOND_A.H3_8_p 
--AND INSTR(AD_BASE_CUT.ADD_NUM,SECOND_A.ADD_NUM,1,1)>0
AND (REGEXP_INSTR(SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2,'HOUSE',1,1)>0 
AND REGEXP_INSTR(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2,'HOUSE',1,1)>0 )
AND AD_BASE_CUT.CLASSIFICATION_TERTIARY= 'Care / Nursing Home' ;
...
AD_BASE_CUT.ADD_NUM, 
  ...
  /length(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2) as score1
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.h3_10=SECOND_A.H3_10_p 
AND REGEXP_INSTR(SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2,'HOME',1,1)>0 
AND REGEXP_INSTR(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2,'HOME',1,1)>0 
AND AD_BASE_CUT.CLASSIFICATION_TERTIARY= 'Care / Nursing Home' ;
...
AND REGEXP_INSTR(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2,'RESIDENTIAL|CARE HOME|NURSING HOME',1,1)>0 
AND AD_BASE_CUT.CLASSIFICATION_TERTIARY= 'Care / Nursing Home' ;
...
AND REGEXP_INSTR(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2,'CENTRE|CARE| RESIDENTIAL|UNIT|RESIDENTIAL|CARE HOME|NURSING HOME',1,1)>0 
AND AD_BASE_CUT.CLASSIFICATION_TERTIARY= 'Care / Nursing Home' ;
...
AND REGEXP_INSTR(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2,'N/ HOME|N /HO|C HME| NRS HME| R H|REST HOME|RESIDENTIAL |RES HOME|R/HOME|R H|RESIDENTIAL|CARE HOME|NURSING HOME|OPH |NURSING|NURSING H|NURSING/H|NURS H | N/H|N H|NURSING HOME|NURSING HO|
NURSING HO | N HOME|N/HOME',1,1)>0 
AND AD_BASE_CUT.CLASSIFICATION_TERTIARY= 'Care / Nursing Home' ;
...
AD_BASE_CUT.ADD_NUM, 
  AD_BASE_CUT.UPRN,
  AD_BASE_CUT.PARENT_UPRN,
  (length(TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2||SECOND_A.CURRENT_LINE3)) - UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2||AD_BASE_CUT.ADDRESS_LINE_3,
  TRIM(LEADING FROM SECOND_A.CURRENT_LINE1||SECOND_A.CURRENT_LINE2||SECOND_A.CURRENT_LINE3)))
  /length(AD_BASE_CUT.ADDRESS_LINE_1) as score,
  AD_BASE_CUT.ADDRESS_STRING_NOPC
FROM SECOND_A,AD_BASE_CUT
 WHERE SECOND_A.CURRENT_LINE1=AD_BASE_CUT.ADDRESS_string_nopc; 
...
AD_BASE_CUT.ADD_NUM, 
  ...
  AD_BASE_CUT.post_town,
  (length(TRIM(LEADING FROM SECOND_A.ADDRESS_STRING)) 
 - UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2||AD_BASE_CUT.ADDRESS_LINE_3||AD_BASE_CUT.POST_TOWN,TRIM(LEADING FROM SECOND_A.ADDRESS_STRING)))
 /length(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_2||AD_BASE_CUT.ADDRESS_LINE_3||AD_BASE_CUT.POST_TOWN) as score1
FROM SECOND_A,AD_BASE_CUT
 WHERE 
  INSTR(SECOND_A.NEIGHBOURS,AD_BASE_CUT.h3_4,1,1)>0
 and AD_BASE_CUT.Add_num=second_a.add_num
AND( INSTR(SECOND_A.address_string ,AD_BASE_CUT.post_town,1,1)>0 OR INSTR(SECOND_A.address_string ,AD_BASE_CUT.LOCALITY,1,1)>0)
AND (instr(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.DESCRIPTION,1,1)>0 OR instr(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ABBR_STREET1,1,1)>0);
...
FROM SECOND_A,AD_BASE_CUT
 WHERE 
  INSTR(SECOND_A.NEAR_NEIGHBOURS,AD_BASE_CUT.h3_4,1,1)>0
 and AD_BASE_CUT.Add_num=second_a.add_num
AND( INSTR(SECOND_A.address_string ,AD_BASE_CUT.post_town,1,1)>0 OR INSTR(SECOND_A.address_string ,AD_BASE_CUT.LOCALITY,1,1)>0)
AND (instr(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.DESCRIPTION,1,1)>0 OR instr(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ABBR_STREET1,1,1)>0);
...
AD_BASE_CUT.ADD_NUM, 
  ...
  UTL_MATCH.jaro_winkler(REGEXP_SUBSTR(second_a.current_line1,'[[:alpha:]].*'),AD_BASE_CUT.ABBR_STREET1) as score,
  AD_BASE_CUT.ABBR_STREET1
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.h3_7=SECOND_A.H3_7_p 
AND UTL_MATCH.jaro_winkler(REGEXP_SUBSTR(second_a.current_line1,'[[:alpha:]].*'),AD_BASE_CUT.ABBR_STREET1)>0.85
AND AD_BASE_CUT.ADD_NUM=SECOND_A.ADD_NUM; 
...
AD_BASE_CUT.ADD_NUM, 
  ...
  UTL_MATCH.jaro_winkler(REGEXP_SUBSTR(second_a.current_line2,'[[:alpha:]].*'),AD_BASE_CUT.ABBR_STREET1) as score,
  AD_BASE_CUT.ABBR_STREET1
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.h3_7=SECOND_A.H3_7_p 
AND UTL_MATCH.jaro_winkler(REGEXP_SUBSTR(second_a.current_line2,'[[:alpha:]].*'),AD_BASE_CUT.ABBR_STREET1)>0.85
AND AD_BASE_CUT.ADD_NUM=SECOND_A.ADD_NUM; 
...
AD_BASE_CUT.ADD_NUM, 
  ...
  UTL_MATCH.jaro_winkler(REGEXP_SUBSTR(second_a.current_line3,'[[:alpha:]].*'),AD_BASE_CUT.ABBR_STREET1) as score,
  AD_BASE_CUT.ABBR_STREET1
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.h3_7=SECOND_A.H3_7_p 
AND UTL_MATCH.jaro_winkler(REGEXP_SUBSTR(second_a.current_line3,'[[:alpha:]].*'),AD_BASE_CUT.ABBR_STREET1)>0.85
AND AD_BASE_CUT.ADD_NUM=SECOND_A.ADD_NUM; 
...
AD_BASE_CUT.ADD_NUM, 
  ...
  AD_BASE_CUT.ADDRESS_STRING_NOPC,
  (length(SECOND_A.ADDRESS_STRING)-
  (UTL_MATCH.jaro_winkler(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ADDRESS_LINE_1||' '||AD_BASE_CUT.ABBR_STREET1||' '||AD_BASE_CUT.POST_TOWN)))
  /length(AD_BASE_CUT.ADDRESS_LINE_1||' '||AD_BASE_CUT.ABBR_STREET1||' '||AD_BASE_CUT.POST_TOWN) as score,
  UTL_MATCH.jaro_winkler(TRIM(regexp_REPLACE(second_a.CURRENT_LINE1, '+[0-9]','') ),AD_BASE_CUT.ABBR_STREET1) as str_score,
  AD_BASE_CUT.ABBR_STREET1
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.h3_6=SECOND_A.H3_6_p
AND UTL_MATCH.jaro_winkler(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ADDRESS_LINE_1||' '||AD_BASE_CUT.ABBR_STREET1||' '||AD_BASE_CUT.POST_TOWN)>0.8
AND AD_BASE_CUT.ADD_NUM=SECOND_A.ADD_NUM; 
...
drop table RESULTS61;
 ...
 -----new bits
 create table word_test1 as  select UPRN,PARENT_UPRN,ID, SECOND_A.STAGE,AD_BASE_CUT.ADDRESS_STRING_NOPC, SECOND_A.ADDRESS_STRING,
SYS.UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_3,SECOND_A.current_line1||' '||SECOND_A.current_line3) AS SCORE,
substr(SECOND_A.ADDRESS_STRING,length(AD_BASE_CUT.ADDRESS_STRING_NOPC)-length(second_a.ADDRESS_STRING)) AS test
from AD_BASE_CUT, SECOND_A 
where AD_BASE_CUT.H3_6=SECOND_A.H3_6_P 
and SYS.UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_3,SECOND_A.current_line1||' '||SECOND_A.current_line3)>0.85
--AND regexp_INSTR(SECOND_A.ADDRESS_STRING, '+[0-9]')=0
--AND regexp_INSTR(SECOND_A.ADDRESS_STRING, '+[A-Z]')>0
--AND second_a.CURRENT_LINE2 !=AD_BASE_CUT.POST_TOWN
AND instr(sECOND_A.address_string ,AD_BASE_CUT.word_one,1,1)>0
and length(AD_BASE_CUT.word_one)>3
AND instr(sECOND_A.address_string ,AD_BASE_CUT.word_two,1,1)>0
and length(AD_BASE_CUT.word_two)>3
AND instr(AD_BASE_CUT.address_string_nopc ,second_a.word_one,1,1)>0
and length(AD_BASE_CUT.word_one)>3
AND instr(AD_BASE_CUT.address_string_nopc ,second_a.word_two,1,1)>0
and length(AD_BASE_CUT.word_two)>3
...
create table word_test2 as select UPRN,PARENT_UPRN,ID, SECOND_A.STAGE,AD_BASE_CUT.ADDRESS_STRING_NOPC, SECOND_A.ADDRESS_STRING,
SYS.UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_3,SECOND_A.current_line1||' '||SECOND_A.current_line3) AS SCORE,
substr(SECOND_A.ADDRESS_STRING,length(AD_BASE_CUT.ADDRESS_STRING_NOPC)-length(second_a.ADDRESS_STRING)) AS test
from AD_BASE_CUT, SECOND_A 
where AD_BASE_CUT.H3_6=SECOND_A.H3_6_P 
and SYS.UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_3,SECOND_A.current_line1||' '||SECOND_A.current_line3)>0.84
--AND regexp_INSTR(SECOND_A.ADDRESS_STRING, '+[0-9]')=0
--AND regexp_INSTR(SECOND_A.ADDRESS_STRING, '+[A-Z]')>0
--AND second_a.CURRENT_LINE2 !=AD_BASE_CUT.POST_TOWN
AND instr(sECOND_A.word_one_m||sECOND_A.word_two_m ||sECOND_A.word_three_m,AD_BASE_CUT.word_one_m,1,1)>0
and length(AD_BASE_CUT.word_one)>3
AND instr(sECOND_A.word_one_m||sECOND_A.word_two_m ||sECOND_A.word_three_m,AD_BASE_CUT.word_two_m,1,1)>0
and length(AD_BASE_CUT.word_two)>3
AND instr(AD_BASE_CUT.word_one_m||AD_BASE_CUT.word_two_m ||AD_BASE_CUT.word_three_m,second_a.word_one_m,1,1)>0
and length(AD_BASE_CUT.word_one)>3
AND instr(AD_BASE_CUT.word_one_m||AD_BASE_CUT.word_two_m ||AD_BASE_CUT.word_three_m,second_a.word_two_m,1,1)>0
and length(AD_BASE_CUT.word_two)>3
and AD_BASE_CUT.ADD_NUM is null 
and SECOND_A.ADD_NUM is null;
--AND regex_like(AD_BASE_CUT.ADDRESS_LINE_3,SECOND_A.address_string)

create table word_test3 as select UPRN,PARENT_UPRN,ID, SECOND_A.STAGE,AD_BASE_CUT.ADDRESS_STRING_NOPC, SECOND_A.ADDRESS_STRING,
SYS.UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_3,SECOND_A.current_line1||' '||SECOND_A.current_line3) AS SCORE,
substr(SECOND_A.ADDRESS_STRING,length(AD_BASE_CUT.ADDRESS_STRING_NOPC)-length(second_a.ADDRESS_STRING)) AS test
from AD_BASE_CUT, SECOND_A 
where AD_BASE_CUT.H3_6=SECOND_A.H3_6_P 
and UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_3,SECOND_A.current_line1||' '||SECOND_A.current_line3)>0.84
--AND regexp_INSTR(SECOND_A.ADDRESS_STRING, '+[0-9]')=0
--AND regexp_INSTR(SECOND_A.ADDRESS_STRING, '+[A-Z]')>0
--AND second_a.CURRENT_LINE2 !=AD_BASE_CUT.POST_TOWN
AND instr(sECOND_A.word_one_m||sECOND_A.word_one_m ,AD_BASE_CUT.word_one_m,1,1)>0
and length(AD_BASE_CUT.word_one)>3
--AND instr(sECOND_A.word_one_m||sECOND_A.word_two_m ,AD_BASE_CUT.word_two_m,1,1)>0
--and length(AD_BASE_CUT.word_two)>3
AND instr(AD_BASE_CUT.word_one_m||AD_BASE_CUT.word_two_m ,second_a.word_one_m,1,1)>0
and length(AD_BASE_CUT.word_one)>3
--AND instr(AD_BASE_CUT.word_one_m||AD_BASE_CUT.word_two_m ,second_a.word_two_m,1,1)>0
--and length(AD_BASE_CUT.word_two)>3
and AD_BASE_CUT.ADD_NUM is null 
and SECOND_A.ADD_NUM is null;


create table word_test4 as select UPRN,PARENT_UPRN,ID,SECOND_A.STAGE, AD_BASE_CUT.ADDRESS_STRING_NOPC, SECOND_A.ADDRESS_STRING,
SYS.UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_3,SECOND_A.current_line1||' '||SECOND_A.current_line3) AS SCORE,
substr(SECOND_A.ADDRESS_STRING,length(AD_BASE_CUT.ADDRESS_STRING_NOPC)-length(second_a.ADDRESS_STRING)) AS test
from AD_BASE_CUT, SECOND_A 
where AD_BASE_CUT.H3_6=SECOND_A.H3_6_P 
...
--AND regexp_INSTR(SECOND_A.ADDRESS_STRING, '+[A-Z]')>0
--AND second_a.CURRENT_LINE2 !=AD_BASE_CUT.POST_TOWN
AND instr(sECOND_A.word_one_m||sECOND_A.word_two_m||sECOND_A.word_three_m ||sECOND_A.word_four_m,AD_BASE_CUT.word_one_m,1,1)>0
and length(AD_BASE_CUT.word_one)>3
AND instr(sECOND_A.word_one_m||sECOND_A.word_two_m||sECOND_A.word_three_m||sECOND_A.word_four_m ,AD_BASE_CUT.word_two_m,1,1)>0
and length(AD_BASE_CUT.word_two)>3
AND instr(AD_BASE_CUT.word_one_m||AD_BASE_CUT.word_two_m||AD_BASE_CUT.word_three_m||AD_BASE_CUT.word_four_m ,second_a.word_one_m,1,1)>0
and length(AD_BASE_CUT.word_one)>3
AND instr(AD_BASE_CUT.word_one_m||AD_BASE_CUT.word_two_m||AD_BASE_CUT.word_three_m||AD_BASE_CUT.word_four_m ,second_a.word_two_m,1,1)>0
and length(AD_BASE_CUT.word_two)>3
and AD_BASE_CUT.ADD_NUM is null 
and SECOND_A.ADD_NUM is null;

create table word_test5 as select UPRN,PARENT_UPRN,ID,SECOND_A.STAGE, AD_BASE_CUT.ADDRESS_STRING_NOPC, SECOND_A.ADDRESS_STRING,
SYS.UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.post_town,SECOND_A.current_line1||' '||SECOND_A.current_line3) AS SCORE,
substr(SECOND_A.ADDRESS_STRING,length(AD_BASE_CUT.ADDRESS_STRING_NOPC)-length(second_a.ADDRESS_STRING)) AS test
from AD_BASE_CUT, SECOND_A 
where AD_BASE_CUT.H3_6=SECOND_A.H3_6_P 
and UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.post_town,SECOND_A.current_line1||' '||SECOND_A.current_line3)>0.84
--AND regexp_INSTR(SECOND_A.ADDRESS_STRING, '+[0-9]')=0
--AND regexp_INSTR(SECOND_A.ADDRESS_STRING, '+[A-Z]')>0
--AND second_a.CURRENT_LINE2 !=AD_BASE_CUT.POST_TOWN
AND instr(sECOND_A.word_one_m||sECOND_A.word_two_m||sECOND_A.word_three_m ||sECOND_A.word_four_m,AD_BASE_CUT.word_one_m,1,1)>0
...
create table test_one as select ID,STAGE,UPRN,PARENT_UPRN, AD_BASE_CUT.ADDRESS_STRING_NOPC, SECOND_A.ADDRESS_STRING,
UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1,SECOND_A.CURRENT_LINE2) AS SCORE 
from AD_BASE_CUT, SECOND_A 
where AD_BASE_CUT.H3_6=SECOND_A.H3_6_P 
...
create table test_two as select ID,STAGE,UPRN,PARENT_UPRN, AD_BASE_CUT.ADDRESS_STRING_NOPC, SECOND_A.ADDRESS_STRING,
UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1,SECOND_A.CURRENT_LINE2) AS SCORE
from AD_BASE_CUT, SECOND_A 
where AD_BASE_CUT.H3_6=SECOND_A.H3_6_P 
...
--AND second_a.CURRENT_LINE2 !=AD_BASE_CUT.POST_TOWN
AND instr(AD_BASE_CUT.ADDRESS_STRING_NOPC,SECOND_A.CURRENT_LINE2,1,1)>0
AND AD_BASE_CUT.ADD_NUM=SECOND_A.ADD_NUM;

create table test_three as select ID,STAGE,UPRN,PARENT_UPRN, AD_BASE_CUT.ADDRESS_STRING_NOPC, SECOND_A.ADDRESS_STRING ,
UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1,SECOND_A.CURRENT_LINE2) AS SCORE
from AD_BASE_CUT, SECOND_A 
where AD_BASE_CUT.H3_6=SECOND_A.H3_6_P 
...
--AND second_a.CURRENT_LINE2 !=AD_BASE_CUT.POST_TOWN
AND instr(AD_BASE_CUT.ADDRESS_STRING_NOPC,SECOND_A.CURRENT_LINE3,1,1)>0
AND AD_BASE_CUT.ADD_NUM=SECOND_A.ADD_NUM;

create table test_four as select ID,STAGE,UPRN,PARENT_UPRN, AD_BASE_CUT.ADDRESS_STRING_NOPC, SECOND_A.ADDRESS_STRING,
UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1,SECOND_A.CURRENT_LINE2) AS SCORE
from AD_BASE_CUT, SECOND_A 
where AD_BASE_CUT.H3_6=SECOND_A.H3_6_P 
AND regexp_INSTR(second_a.CURRENT_LINE2, '+[0-9]')>0
AND regexp_INSTR(second_a.CURRENT_LINE2, '+[A-Z]')>0
--AND second_a.CURRENT_LINE2 !=AD_BASE_CUT.POST_TOWN
AND UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1,SECOND_A.CURRENT_LINE2)<3
AND UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1,SECOND_A.CURRENT_LINE2)>=0
AND AD_BASE_CUT.ADD_NUM=SECOND_A.ADD_NUM;

create table test_five as select ID,STAGE,UPRN,PARENT_UPRN,AD_BASE_CUT.ADDRESS_STRING_NOPC, SECOND_A.ADDRESS_STRING,
UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_2,SECOND_A.CURRENT_LINE2) AS SCORE
from AD_BASE_CUT, SECOND_A 
where AD_BASE_CUT.H3_6=SECOND_A.H3_6_P 
AND regexp_INSTR(second_a.CURRENT_LINE2, '+[0-9]')>0
AND regexp_INSTR(second_a.CURRENT_LINE2, '+[A-Z]')>0
--AND second_a.CURRENT_LINE2 !=AD_BASE_CUT.POST_TOWN
AND UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_2,SECOND_A.CURRENT_LINE2)<3
AND UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_2,SECOND_A.CURRENT_LINE2)>=0
AND AD_BASE_CUT.ADD_NUM=SECOND_A.ADD_NUM;

create table test_six as select ID,STAGE,UPRN,PARENT_UPRN, AD_BASE_CUT.ADDRESS_STRING_NOPC, SECOND_A.ADDRESS_STRING,
UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_2,SECOND_A.CURRENT_LINE1) AS SCORE
from AD_BASE_CUT, SECOND_A 
where AD_BASE_CUT.H3_6=SECOND_A.H3_6_P 
AND regexp_INSTR(second_a.CURRENT_LINE1, '+[0-9]')>0
AND regexp_INSTR(second_a.CURRENT_LINE1, '+[A-Z]')>0
--AND second_a.CURRENT_LINE2 !=AD_BASE_CUT.POST_TOWN
AND UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_2,SECOND_A.CURRENT_LINE1)<3
AND UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_2,SECOND_A.CURRENT_LINE1)>=0
AND AD_BASE_CUT.ADD_NUM=SECOND_A.ADD_NUM;


create table test_seven as select ID,STAGE,UPRN,PARENT_UPRN, AD_BASE_CUT.ADDRESS_STRING_NOPC, SECOND_A.ADDRESS_STRING,
UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1,SECOND_A.CURRENT_LINE1) AS SCORE
from AD_BASE_CUT, SECOND_A 
where AD_BASE_CUT.H3_6=SECOND_A.H3_6_P 
AND regexp_INSTR(second_a.CURRENT_LINE1, '+[0-9]')=0
AND regexp_INSTR(second_a.CURRENT_LINE1, '+[A-Z]')>0
--AND second_a.CURRENT_LINE2 !=AD_BASE_CUT.POST_TOWN
AND UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1,SECOND_A.CURRENT_LINE1)<2
AND UTL_MATCH.EDIT_DISTANCE(AD_BASE_CUT.ADDRESS_LINE_1,SECOND_A.CURRENT_LINE1)>=0
AND AD_BASE_CUT.ADD_NUM is null and SECOND_A.ADD_NUM is null;

create table test_eight as select ID,STAGE,UPRN,PARENT_UPRN, AD_BASE_CUT.ADDRESS_STRING_NOPC, SECOND_A.ADDRESS_STRING,
SYS.UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.ADDRESS_LINE_1,SECOND_A.CURRENT_LINE2) AS SCORE
from AD_BASE_CUT, SECOND_A 
where AD_BASE_CUT.H3_6=SECOND_A.H3_6_P 
AND regexp_INSTR(second_a.CURRENT_LINE2, '+[0-9]')=0
AND regexp_INSTR(second_a.CURRENT_LINE2, '+[A-Z]')>0
...
drop table TEST_UNION;
 ...
 create table word_test6 as  select ID, STAGE,UPRN,PARENT_UPRN,AD_BASE_CUT.ADDRESS_STRING_NOPC, SECOND_A.ADDRESS_STRING,
SYS.UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_3,SECOND_A.current_line1||' '||SECOND_A.current_line3) AS SCORE,
substr(SECOND_A.ADDRESS_STRING,length(AD_BASE_CUT.ADDRESS_STRING_NOPC)-length(second_a.ADDRESS_STRING)) AS test
from AD_BASE_CUT, SECOND_A 
where AD_BASE_CUT.H3_6=SECOND_A.H3_6_P 
--and SYS.UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_3,SECOND_A.current_line1||' '||SECOND_A.current_line3)>0.7
--AND regexp_INSTR(SECOND_A.ADDRESS_STRING, '+[0-9]')=0
--AND regexp_INSTR(SECOND_A.ADDRESS_STRING, '+[A-Z]')>0
--AND second_a.CURRENT_LINE2 !=AD_BASE_CUT.POST_TOWN
AND instr(sECOND_A.address_string ,AD_BASE_CUT.word_one,1,1)>0
...
create table word_test7 as select ID, STAGE,UPRN,PARENT_UPRN,AD_BASE_CUT.ADDRESS_STRING_NOPC, SECOND_A.ADDRESS_STRING,
SYS.UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_3,SECOND_A.current_line1||' '||SECOND_A.current_line3) AS SCORE,
substr(SECOND_A.ADDRESS_STRING,length(AD_BASE_CUT.ADDRESS_STRING_NOPC)-length(second_a.ADDRESS_STRING)) AS test
from AD_BASE_CUT, SECOND_A 
where AD_BASE_CUT.H3_6=SECOND_A.H3_6_P 
and SYS.UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_3,SECOND_A.current_line1||' '||SECOND_A.current_line3)>0.55
--AND regexp_INSTR(SECOND_A.ADDRESS_STRING, '+[0-9]')=0
--AND regexp_INSTR(SECOND_A.ADDRESS_STRING, '+[A-Z]')>0
--AND second_a.CURRENT_LINE2 !=AD_BASE_CUT.POST_TOWN
AND instr(sECOND_A.word_one_m||sECOND_A.word_two_m ||sECOND_A.word_three_m,AD_BASE_CUT.word_one_m,1,1)>0
...
create table word_test8 as select ID, STAGE,UPRN,PARENT_UPRN,AD_BASE_CUT.ADDRESS_STRING_NOPC, SECOND_A.ADDRESS_STRING,
SYS.UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_3,SECOND_A.current_line1||' '||SECOND_A.current_line3) AS SCORE,
substr(SECOND_A.ADDRESS_STRING,length(AD_BASE_CUT.ADDRESS_STRING_NOPC)-length(second_a.ADDRESS_STRING)) AS test
from AD_BASE_CUT, SECOND_A 
where AD_BASE_CUT.H3_6=SECOND_A.H3_6_P 
...
create table word_test9 as select ID, STAGE,UPRN,PARENT_UPRN,AD_BASE_CUT.ADDRESS_STRING_NOPC, SECOND_A.ADDRESS_STRING,
SYS.UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.ADDRESS_LINE_3,SECOND_A.current_line1||' '||SECOND_A.current_line3) AS SCORE,
substr(SECOND_A.ADDRESS_STRING,length(AD_BASE_CUT.ADDRESS_STRING_NOPC)-length(second_a.ADDRESS_STRING)) AS test
from AD_BASE_CUT, SECOND_A 
where AD_BASE_CUT.H3_6=SECOND_A.H3_6_P 
...
create table word_test10 as select ID, STAGE,UPRN,PARENT_UPRN,AD_BASE_CUT.ADDRESS_STRING_NOPC, SECOND_A.ADDRESS_STRING,
SYS.UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.ADDRESS_LINE_1||AD_BASE_CUT.post_town,SECOND_A.current_line1||' '||SECOND_A.current_line3) AS SCORE,
substr(SECOND_A.ADDRESS_STRING,length(AD_BASE_CUT.ADDRESS_STRING_NOPC)-length(second_a.ADDRESS_STRING)) AS test
from AD_BASE_CUT, SECOND_A 
where AD_BASE_CUT.H3_6=SECOND_A.H3_6_P 
...
--AD_BASE_CUT.PARENT_UPRN,
--AD_BASE_CUT.ADDRESS_STRING_NOPC,
--UTL_MATCH.jaro_winkler(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ADDRESS_LINE_1||' '||AD_BASE_CUT.ABBR_STREET1||' '||AD_BASE_CUT.POST_TOWN)as score,
--UTL_MATCH.jaro_winkler(TRIM(regexp_REPLACE(second_a.CURRENT_LINE1, '+[0-9]','') ),AD_BASE_CUT.ABBR_STREET1) as str_score,
--AD_BASE_CUT.ABBR_STREET1
--FROM SECOND_A,AD_BASE_CUT
--WHERE AD_BASE_CUT.h3_6=SECOND_A.H3_6_p
--AND UTL_MATCH.jaro_winkler(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ADDRESS_LINE_1||' '||AD_BASE_CUT.ABBR_STREET1||' '||AD_BASE_CUT.POST_TOWN)>0.8
--AND  UTL_MATCH.jaro_winkler(TRIM(regexp_REPLACE(second_a.CURRENT_LINE1, '+[0-9]','') ),AD_BASE_CUT.ABBR_STREET1) >.8
--AND AD_BASE_CUT.ADD_NUM=SECOND_A.ADD_NUM; 
...
AD_BASE_CUT.ADD_NUM, 
  ...
  AD_BASE_CUT.PARENT_UPRN,
  AD_BASE_CUT.ADDRESS_STRING_NOPC,
  UTL_MATCH.jaro_winkler(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ADDRESS_LINE_1||' ' ||ADDRESS_LINE_3||' '||POST_TOWN) as score,
  UTL_MATCH.jaro_winkler(TRIM(regexp_REPLACE(second_a.CURRENT_LINE1, '+[0-9]','') ),AD_BASE_CUT.ABBR_STREET1) as str_score,
  AD_BASE_CUT.ABBR_STREET1
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.h3_7=SECOND_A.H3_7_p 
AND UTL_MATCH.jaro_winkler(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ADDRESS_LINE_1||' ' ||ADDRESS_LINE_3||' '||POST_TOWN)>0.75
AND UTL_MATCH.jaro_winkler(TRIM(regexp_REPLACE(second_a.CURRENT_LINE1, '+[0-9]','') ),AD_BASE_CUT.ABBR_STREET1)>0.8
...
AD_BASE_CUT.ADD_NUM, 
  ...
  AD_BASE_CUT.ADDRESS_STRING_NOPC,
   UTL_MATCH.jaro_winkler(TRIM(regexp_REPLACE(second_a.CURRENT_LINE1, '+[0-9]','') ),AD_BASE_CUT.ABBR_STREET1) as str_score,
   UTL_MATCH.edit_distance(regexp_REPLACE(SECOND_A.ADDRESS_STRING, '[[:space:]]','') ,regexp_REPLACE(AD_BASE_CUT.ADDRESS_STRING_NOPC, '[[:space:]]','')) as score,
  AD_BASE_CUT.ABBR_STREET1
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.h3_6=SECOND_A.H3_6_p 
AND UTL_MATCH.edit_distance(regexp_REPLACE(SECOND_A.ADDRESS_STRING, '[[:space:]]','') ,regexp_REPLACE(AD_BASE_CUT.ADDRESS_STRING_NOPC, '[[:space:]]','')) <5
--AND UTL_MATCH.edit_distance(regexp_REPLACE(AD_BASE_CUT.ADDRESS_STRING_NOPC, '[[:space:]]',''),regexp_REPLACE(SECOND_A.ADDRESS_STRING, '[[:space:]]','') ) <5
AND AD_BASE_CUT.ADD_NUM=SECOND_A.ADD_NUM; 
...
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.h3_6=SECOND_A.H3_6_p 
AND UTL_MATCH.edit_distance(regexp_REPLACE(SECOND_A.ADDRESS_STRING, '[[:space:]]','') ,regexp_REPLACE(AD_BASE_CUT.ADDRESS_STRING_NOPC, '[[:space:]]',''))<4
AND UTL_MATCH.jaro_winkler(TRIM(regexp_REPLACE(second_a.CURRENT_LINE1, '+[0-9]','') ),AD_BASE_CUT.ABBR_STREET1)>0.65
AND AD_BASE_CUT.ADD_NUM=SECOND_A.ADD_NUM; 
...
AD_BASE_CUT.ADD_NUM, 
  ...
  AD_BASE_CUT.PARENT_UPRN,
  AD_BASE_CUT.ADDRESS_STRING_NOPC,
  UTL_MATCH.jaro_winkler(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ADDRESS_LINE_1||' ' ||ADDRESS_LINE_2||' '||POST_TOWN) as score,
  UTL_MATCH.jaro_winkler(TRIM(regexp_REPLACE(second_a.CURRENT_LINE1, '+[0-9]','') ),AD_BASE_CUT.ABBR_STREET1) as str_score,
  AD_BASE_CUT.ABBR_STREET1
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.h3_7=SECOND_A.H3_7_p 
AND UTL_MATCH.jaro_winkler(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ADDRESS_LINE_1||' ' ||ADDRESS_LINE_2||' '||POST_TOWN)>0.8
AND UTL_MATCH.jaro_winkler(TRIM(regexp_REPLACE(second_a.CURRENT_LINE1, '+[0-9]','') ),AD_BASE_CUT.ABBR_STREET1)>0.8
--AND LENGTH(TRIM(regexp_REPLACE(second_a.CURRENT_LINE1, '+[0-9]','')))>4
AND (AD_BASE_CUT.BUILD_NO=SECOND_A.ADD_NUM OR (AD_BASE_CUT.SUB_UNIT=SECOND_A.ADD_NUM)); 
...
AD_BASE_CUT.ADD_NUM, 
  ...
  AD_BASE_CUT.PARENT_UPRN,
  AD_BASE_CUT.ADDRESS_STRING_NOPC,
  UTL_MATCH.jaro_winkler(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ADDRESS_LINE_1||' '||POST_TOWN) as score,
  UTL_MATCH.jaro_winkler(TRIM(regexp_REPLACE(second_a.CURRENT_LINE1, '+[0-9]','') ),AD_BASE_CUT.ABBR_STREET1) as str_score,
  AD_BASE_CUT.ABBR_STREET1
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.h3_7=SECOND_A.H3_7_p 
--AND UTL_MATCH.jaro_winkler(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ADDRESS_LINE_1||' '||POST_TOWN)>0.8
AND INSTR(AD_BASE_CUT.ABBR_STREET1,TRIM(regexp_REPLACE(second_a.CURRENT_LINE1, '+[0-9]','') ),1,1)>0
--AND LENGTH(TRIM(regexp_REPLACE(second_a.CURRENT_LINE1, '+[0-9]','')))>4
AND AD_BASE_CUT.BUILD_NO=SECOND_A.ADD_NUM AND SECOND_A.BUILD_NO IS NULL;
...
AD_BASE_CUT.ADD_NUM, 
  ...
  AD_BASE_CUT.ADDRESS_STRING_NOPC,
  UTL_MATCH.jaro_winkler(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ADDRESS_LINE_1||' '||POST_TOWN) as score,
  UTL_MATCH.jaro_winkler(TRIM(regexp_REPLACE(second_a.CURRENT_LINE2, '+[0-9]','') ),AD_BASE_CUT.ABBR_STREET1) as str_score,
  AD_BASE_CUT.ABBR_STREET1
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.h3_7=SECOND_A.H3_7_p 
--AND UTL_MATCH.jaro_winkler(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ADDRESS_LINE_1||' '||POST_TOWN)>0.8
AND INSTR(AD_BASE_CUT.ABBR_STREET1,TRIM(regexp_REPLACE(second_a.CURRENT_LINE2, '+[0-9]','') ),1,1)>0
AND LENGTH(TRIM(regexp_REPLACE(second_a.CURRENT_LINE1, '+[0-9]','')))<4
AND AD_BASE_CUT.BUILD_NO=SECOND_A.ADD_NUM AND SECOND_A.BUILD_NO IS NULL;
...
FROM SECOND_A,AD_BASE_CUT
WHERE AD_BASE_CUT.h3_7=SECOND_A.H3_7_p 
--AND UTL_MATCH.jaro_winkler(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ADDRESS_LINE_1||' '||POST_TOWN)>0.9
--AND AD_BASE_CUT.ADDRESS_LINE_2=TRIM(regexp_REPLACE(second_a.CURRENT_LINE1, '+[0-9]','') )
AND AD_BASE_CUT.WORD_ONE=SECOND_A.WORD_ONE
AND UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.WORD_TWO,SECOND_A.WORD_TWO)>0.8
AND UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.DESCRIPTION,TRIM(regexp_REPLACE(second_a.CURRENT_LINE1, '+[0-9]','')))>0.8;
...
AND AD_BASE_CUT.WORD_ONE=SECOND_A.WORD_ONE
AND UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.WORD_TWO,SECOND_A.WORD_TWO)>0.8
AND UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.WORD_THREE,SECOND_A.WORD_THREE)>0.8
AND UTL_MATCH.JARO_WINKLER(AD_BASE_CUT.DESCRIPTION,TRIM(regexp_REPLACE(second_a.CURRENT_LINE2, '+[0-9]','')))>0.8;
...
AD_BASE_CUT.build_no,
  ...
  AD_BASE_CUT.PARENT_UPRN,
  AD_BASE_CUT.ADDRESS_STRING_NOPC,
  UTL_MATCH.edit_distance(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ADDRESS_STRING_NOPC) as score,
  second_a.range_lower,
  second_a.range_upper,
  AD_BASE_CUT.ABBR_STREET1
FROM SECOND_A,AD_BASE_CUT
...
--AND UTL_MATCH.jaro_winkler(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ADDRESS_LINE_1||' '||POST_TOWN)>0.8
and instr(second_a.address_string,AD_BASE_CUT.abbr_street1,1,1)>0
AND AD_BASE_CUT.build_no between second_a.range_lower and second_a.range_upper
--AND MOD ( second_a.range_lower,2) = MOD(AD_BASE_CUT.BUILD_NO,2)
AND INSTR(AD_BASE_CUT.ADDRESS_STRING_NOPC,SECOND_A.ADD_STRING_WORKING,1,1)>0;
...
--AND UTL_MATCH.jaro_winkler(SECOND_A.ADDRESS_STRING,AD_BASE_CUT.ADDRESS_LINE_1||' '||POST_TOWN)>0.8
and instr(second_a.address_string,AD_BASE_CUT.abbr_street1,1,1)>0
AND AD_BASE_CUT.build_no between second_a.range_lower2 and second_a.range_upper2
--AND MOD ( second_a.range_lower,2) = MOD(AD_BASE_CUT.BUILD_NO,2)
AND INSTR(AD_BASE_CUT.ADDRESS_STRING_NOPC,SECOND_A.ADD_STRING_WORKING,1,1)>0;
...
AD_BASE_CUT.ADDRESS_STRING_NOPC,
SECOND_A.ADDRESS_STRING,
substr(SECOND_A.ADDRESS_STRING,greatest(-length(AD_BASE_CUT.ADDRESS_STRING_NOPC)),length( SECOND_A.ADDRESS_STRING))  AS TEST,
TRIM(regexp_REPLACE(second_a.ADDRESS_STRING, '[A-Z]','')) AS TEST_NUM,
UTL_MATCH.JARO_WINKLER(SECOND_A.ADDRESS_STRING,substr(SECOND_A.ADDRESS_STRING,-length(AD_BASE_CUT.ADDRESS_STRING_NOPC),length( SECOND_A.ADDRESS_STRING)) ) AS SCORE
FROM SECOND_A, AD_BASE_CUT
WHERE AD_BASE_CUT.h3_10=SECOND_A.H3_10_p 
AND TRIM(regexp_REPLACE(second_a.ADDRESS_STRING, '[A-Z]','') )=AD_BASE_CUT.ADD_NUM
AND INSTR(AD_BASE_CUT.ADDRESS_STRING_NOPC,SECOND_A.ADD_STRING_WORKING,1,1)>0;
...
WHERE AD_BASE_CUT.h3_7=SECOND_A.H3_7_p 
and length(AD_BASE_CUT.address_line_1)>4
AND INSTR(SECOND_A.ADD_STRING_WORKING,AD_BASE_CUT.ADDRESS_LINE_1,1,1)>0;
...
AD_BASE_CUT.build_no,second_a.build_no as build_in,
AD_BASE_CUT.ADDRESS_STRING_NOPC,
SECOND_A.ADDRESS_STRING,
substr(SECOND_A.ADDRESS_STRING,greatest(-length(AD_BASE_CUT.ADDRESS_STRING_NOPC)),length( SECOND_A.ADDRESS_STRING))  AS TEST,
TRIM(regexp_REPLACE(second_a.ADDRESS_STRING, '[A-Z]','')) AS TEST_NUM,
--UTL_MATCH.JARO_WINKLER(SECOND_A.ADDRESS_STRING,substr(SECOND_A.ADDRESS_STRING,-length(AD_BASE_CUT.ADDRESS_STRING_NOPC),length( SECOND_A.ADDRESS_STRING)) ) 
UTL_MATCH.JARO_WINKLER(SECOND_A.ADD_STRING_working,substr(SECOND_A.ADDRESS_STRING,-length(AD_BASE_CUT.ADDRESS_STRING_NOPC),length( SECOND_A.ADDRESS_STRING)) )AS SCORE
FROM SECOND_A, AD_BASE_CUT
WHERE AD_BASE_CUT.h3_6=SECOND_A.H3_6_p 
and AD_BASE_CUT.build_no=second_a.build_no 
--or second_a.build_no BETWEEN AD_BASE_CUT.range_lower and AD_BASE_CUT.range_upper)
and instr(second_a.address_string,AD_BASE_CUT.description,1,1)>0 
--AND instr(AD_BASE_CUT.ADDRESS_string_nopc,SECOND_A.word_two,1,1)>0
--and instr(AD_BASE_CUT.ADDRESS_string_nopc,trim(SECOND_A.word_two),1,1)>0
and UTL_MATCH.JARO_WINKLER(SECOND_A.ADD_STRING_working,substr(SECOND_A.ADDRESS_STRING,-length(AD_BASE_CUT.ADDRESS_STRING_NOPC),length( SECOND_A.ADDRESS_STRING)) )>0.61;
 --and instr(second_a.current_line3,AD_BASE_CUT.post_town,1,1)>0;
...
--CH FINDING
CREATE TABLE RESULTS_82_A AS SELECT
ID,
SECOND_A.STAGE,
ad_base_cut.UPRN,
ad_base_cut.PARENT_UPRN,
...
FROM SECOND_A, AD_BASE_cut
WHERE ad_base_cut.h3_8=SECOND_A.H3_8_p 
AND UTL_MATCH.JARO_WINKLER(SECOND_A.ADDRESS_STRING,substr(SECOND_A.ADDRESS_STRING,-length(AD_BASE_cut.ADDRESS_STRING_NOPC),length( SECOND_A.ADDRESS_STRING)) ) >0.7
--AND instr(ad_base_cut.address_string_nopc,second_a.word_one||' '||second_a.word_two,1,1)>0
and ad_base_cut.build_no=second_a.build_no;

CREATE TABLE RESULTS_82_B AS SELECT
ID,
SECOND_A.STAGE,
ad_base_cut.UPRN,
ad_base_cut.PARENT_UPRN,
...
CREATE TABLE RESULTS_82_C AS SELECT
ID,
SECOND_A.STAGE,
ad_base_cut.UPRN,
ad_base_cut.PARENT_UPRN,
...
AND UTL_MATCH.JARO_WINKLER(SECOND_A.ADDRESS_STRING,substr(SECOND_A.ADDRESS_STRING,-length(AD_BASE_cut.ADDRESS_STRING_NOPC),length( SECOND_A.ADDRESS_STRING)) ) >0.7
AND ad_base_cut.word_one=second_a.word_one 
AND INSTR(ad_base_cut.ADDRESS_STRING_NOPC,second_a.BUILD_NO,1,1)>0;

CREATE TABLE RESULTS_82_D AS SELECT
ID,
SECOND_A.STAGE,
ad_base_cut.UPRN,
ad_base_cut.PARENT_UPRN,
...
CREATE TABLE RESULTS_82_E AS SELECT
ID,
SECOND_A.STAGE,
ad_base_cut.UPRN,
ad_base_cut.PARENT_UPRN,
...
--AND UTL_MATCH.JARO_WINKLER(SECOND_A.ADDRESS_STRING,substr(SECOND_A.ADDRESS_STRING,-length(AD_BASE_cut.ADDRESS_STRING_NOPC),length( SECOND_A.ADDRESS_STRING)) ) >0.7
AND instr(ad_base_cut.address_string_nopc,second_a.add_string_working,1,1)>0
AND instr(ad_base_cut.address_string_nopc,second_a.sub_unit,1,1)>0;

CREATE TABLE RESULTS_82_F AS SELECT
ID,
SECOND_A.STAGE,
ad_base_cut.UPRN,
ad_base_cut.PARENT_UPRN,
...
FROM SECOND_A, AD_BASE_cut
WHERE ad_base_cut.h3_10=SECOND_A.H3_10_p 
AND UTL_MATCH.JARO_WINKLER(SECOND_A.ADD_NO_SPACE,regexp_REPLACE(AD_BASE_cut.ADDRESS_STRING_NOPC,' ','' ) )>0.7
AND instr(ad_base_cut.address_string_nopc,second_a.BUILD_NO,1,1)>0;
--AND instr(ad_base_cut.address_string_nopc,second_a.sub_unit,1,1)>0;
...
AS
select ID,UPRN, PARENT_UPRN, STAGE, ADDRESS_STRING, ADDRESS_STRING_NOPC , SCORE from RESULTS_82_A
union 
select ID,UPRN, PARENT_UPRN, STAGE, ADDRESS_STRING, ADDRESS_STRING_NOPC  , SCORE from RESULTS_82_B
union 
select ID,UPRN, PARENT_UPRN, STAGE, ADDRESS_STRING, ADDRESS_STRING_NOPC  , SCORE from RESULTS_82_C
union 
select ID,UPRN, PARENT_UPRN, STAGE, ADDRESS_STRING, ADDRESS_STRING_NOPC  , SCORE from RESULTS_82_D
union
select ID,UPRN, PARENT_UPRN, STAGE, ADDRESS_STRING, ADDRESS_STRING_NOPC  , SCORE from RESULTS_82_E
union
select ID,UPRN, PARENT_UPRN, STAGE,  ADDRESS_STRING, ADDRESS_STRING_NOPC  , SCORE from RESULTS_82_F;

UPDATE UNION_A SET STAGE= '82';
...
AND COUNT_P_UPRN =1
ORDER BY ID, ADDRESS_STRING, ADDRESS_STRING_NOPC;
ALTER TABLE RESULTS82a COMPRESS;
...
drop table RESULTS_82_A;
drop table RESULTS_82_B;
drop table RESULTS_82_C;
drop table RESULTS_82_D;
drop table RESULTS_82_E;
drop table RESULTS_82_F;

CREATE TABLE RESULTS_83_A as SELECT
ID,
SECOND_A.STAGE,
AD_BASE_CUT.UPRN,
AD_BASE_CUT.PARENT_UPRN,
...
UTL_MATCH.JARO_WINKLER(SECOND_A.ADD_STRING_working,substr(SECOND_A.ADDRESS_STRING,-length(AD_BASE_CUT.ADDRESS_STRING_NOPC),length( SECOND_A.ADDRESS_STRING)) )AS SCORE
FROM SECOND_A, AD_BASE_CUT
WHERE instr(SECOND_A.neighbours,AD_BASE_CUT.h3_4,1,1)>0
and AD_BASE_CUT.build_no=second_a.build_no 
and instr(second_a.address_string,AD_BASE_CUT.abbr_street1,1,1)>0 
and UTL_MATCH.JARO_WINKLER(SECOND_A.ADD_STRING_working,substr(SECOND_A.ADDRESS_STRING,-length(AD_BASE_CUT.ADDRESS_STRING_NOPC),length( SECOND_A.ADDRESS_STRING)) )>0.6;

CREATE TABLE RESULTS_83_B AS SELECT
ID,
SECOND_A.STAGE,
ad_base_cut.UPRN,
ad_base_cut.PARENT_UPRN,
...
substr(SECOND_A.ADDRESS_STRING,greatest(-length(AD_BASE_cut.ADDRESS_STRING_NOPC)),length( SECOND_A.ADDRESS_STRING))  AS TEST,
TRIM(regexp_REPLACE(second_a.ADDRESS_STRING, '[A-Z]','')) AS TEST_NUM,
UTL_MATCH.JARO_WINKLER(SECOND_A.ADDRESS_STRING,substr(SECOND_A.ADDRESS_STRING,greatest(-length(AD_BASE_cut.ADDRESS_STRING_NOPC)),length( SECOND_A.ADDRESS_STRING))   ) AS SCORE
FROM SECOND_A, AD_BASE_cut
WHERE  instr(SECOND_A.H3_4_P,AD_BASE_CUT.h3_4,1,1)>0
AND UTL_MATCH.JARO_WINKLER(SECOND_A.ADDRESS_STRING,substr(SECOND_A.ADDRESS_STRING,greatest(-length(AD_BASE_cut.ADDRESS_STRING_NOPC)),length( SECOND_A.ADDRESS_STRING))   ) >0.7
AND instr(second_a.ADDRESS_STRING,AD_BASE_CUT.ABBR_STREET1,1,1)>0
and ad_base_cut.build_no=second_a.build_no;

CREATE TABLE RESULTS_83_C AS SELECT
ID,
SECOND_A.STAGE,
ad_base_cut.UPRN,
ad_base_cut.PARENT_UPRN,
...
CREATE TABLE RESULTS_83_D AS SELECT
ID,
SECOND_A.STAGE,
ad_base_cut.UPRN,
ad_base_cut.PARENT_UPRN,
...
UTL_MATCH.JARO_WINKLER(SECOND_A.ADDRESS_STRING,substr(SECOND_A.ADDRESS_STRING,-length(AD_BASE_cut.ADDRESS_STRING_NOPC),length( SECOND_A.ADDRESS_STRING)) ) AS SCORE
FROM SECOND_A, AD_BASE_cut
WHERE  SECOND_A.H3_4_p=AD_BASE_CUT.h3_4
AND UTL_MATCH.JARO_WINKLER(SECOND_A.ADDRESS_STRING,substr(SECOND_A.ADDRESS_STRING,-length(AD_BASE_cut.ADDRESS_STRING_NOPC),length( SECOND_A.ADDRESS_STRING)) ) >0.65
AND INSTR(ad_base_cut.ADDRESS_STRING_NOPC,second_a.word_one ,1,1)>0
AND INSTR(ad_base_cut.ADDRESS_STRING_NOPC,second_a.word_two,1,1)>0
AND INSTR(second_a.ADDRESS_STRING,ad_base_cut.abbr_street1,1,1)>0
AND INSTR(ad_base_cut.ADDRESS_STRING_NOPC,second_a.BUILD_NO,1,1)>0;

CREATE TABLE RESULTS_83_E AS SELECT
ID,
SECOND_A.STAGE,
ad_base_cut.UPRN,
ad_base_cut.PARENT_UPRN,
...
CREATE TABLE RESULTS_83_F AS SELECT
ID,
SECOND_A.STAGE,
ad_base_cut.UPRN,
ad_base_cut.PARENT_UPRN,
...
CREATE TABLE RESULTS_83_G AS SELECT
ID,
SECOND_A.STAGE,
ad_base_cut.UPRN,
ad_base_cut.PARENT_UPRN,
...
CREATE TABLE UNION_B
AS
select ID,UPRN, PARENT_UPRN, STAGE, ADDRESS_STRING, ADDRESS_STRING_NOPC , SCORE from RESULTS_83_A
union 
select ID,UPRN, PARENT_UPRN, STAGE, ADDRESS_STRING, ADDRESS_STRING_NOPC , SCORE from RESULTS_83_B
union 
select ID,UPRN, PARENT_UPRN, STAGE, ADDRESS_STRING, ADDRESS_STRING_NOPC  , SCORE from RESULTS_83_C
union 
select ID,UPRN, PARENT_UPRN, STAGE, ADDRESS_STRING, ADDRESS_STRING_NOPC  , SCORE from RESULTS_83_D
union 
select ID,UPRN, PARENT_UPRN, STAGE, ADDRESS_STRING, ADDRESS_STRING_NOPC  , SCORE from RESULTS_83_E
union
select ID,UPRN, PARENT_UPRN, STAGE, ADDRESS_STRING, ADDRESS_STRING_NOPC  , SCORE from RESULTS_83_F
union
select ID,UPRN, PARENT_UPRN, STAGE,  ADDRESS_STRING, ADDRESS_STRING_NOPC  , SCORE from RESULTS_83_G;

UPDATE UNION_B SET STAGE= '83';

CREATE TABLE RESULTS83a AS SELECT DISTINCT ID,STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC,SCORE,MAX_SCORE,COUNT_P_UPRN FROM(
SELECT ID, STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC, SCORE,
mAX(SCORE) OVER (PARTITION BY ID) AS MAX_SCORE,
DENSE_RANK() OVER(PARTITION BY ID ORDER BY PARENT_UPRN) AS COUNT_P_UPRN
FROM UNION_B)
...
AND COUNT_P_UPRN =1
ORDER BY ID, ADDRESS_STRING, ADDRESS_STRING_NOPC;
ALTER TABLE RESULTS83a COMPRESS;
...
drop table RESULTS_83_A;
drop table RESULTS_83_B;
drop table RESULTS_83_C;
drop table RESULTS_83_D;
drop table RESULTS_83_E;
drop table RESULTS_83_F;
drop table RESULTS_83_G;

CREATE TABLE RESULTS_84 AS SELECT
ID,
SECOND_A.STAGE,
ad_base_cut.UPRN,
ad_base_cut.PARENT_UPRN,
...
UTL_MATCH.JARO_WINKLER(SECOND_A.ADDRESS_STRING,substr(SECOND_A.ADDRESS_STRING,-length(AD_BASE_cut.ADDRESS_STRING_NOPC),length( SECOND_A.ADDRESS_STRING)) ) AS SCORE
FROM SECOND_A, AD_BASE_cut
WHERE  SECOND_A.H3_10_p=AD_BASE_CUT.h3_10
AND INSTR(ad_base_cut.ADDRESS_STRING_NOPC,second_a.word_one ,1,1)>0
AND INSTR(ad_base_cut.ADDRESS_STRING_NOPC,second_a.word_two,1,1)>0
AND INSTR(ad_base_cut.ADDRESS_STRING_NOPC,second_a.word_three,1,1)>0;

UPDATE RESULTS_84 SET STAGE= '84';
...
AND COUNT_P_UPRN =1
ORDER BY ID, ADDRESS_STRING, ADDRESS_STRING_NOPC;
ALTER TABLE RESULTS84a COMPRESS;

DELETE FROM SECOND_A
WHERE EXISTS( SELECT id FROM RESULTS84a Where SECOND_A.ID = RESULTS84a.ID);
COMMIT;

drop table RESULTS_84;
--AND UTL_MATCH.JARO_WINKLER(SECOND_A.ADD_NO_SPACE,regexp_REPLACE(AD_BASE_cut.ADDRESS_STRING_NOPC,' ','' ) )>0.7
--AND instr(ad_base_cut.address_string_nopc,second_a.BUILD_NO,1,1)>0
--AND INSTR(second_a.ADDRESS_STRING,ad_base_cut.abbr_street1,1,1)>0
CREATE TABLE RESULTS_85 AS SELECT
ID,
SECOND_A.STAGE,
ad_base_cut.UPRN,
ad_base_cut.PARENT_UPRN,
...
UPDATE RESULTS_85 SET STAGE= '85';
...
AND COUNT_P_UPRN =1
ORDER BY ID, ADDRESS_STRING, ADDRESS_STRING_NOPC;
ALTER TABLE RESULTS85a COMPRESS;

DELETE FROM SECOND_A
WHERE EXISTS( SELECT id FROM RESULTS85a Where SECOND_A.ID = RESULTS85a.ID);
COMMIT;

drop table RESULTS_85;

CREATE TABLE RESULTS_86 AS SELECT
ID,
SECOND_A.STAGE,
ad_base_cut.UPRN,
ad_base_cut.PARENT_UPRN,
...
WHERE  SECOND_A.H3_7_p=AD_BASE_CUT.h3_7
and ad_base_cut.abbr_street1 is not null
and instr(second_a.add_string_working,ad_base_cut.abbr_street1,1,1)>0;

UPDATE RESULTS_86 SET STAGE= '86';
...
DELETE FROM SECOND_A
WHERE EXISTS( SELECT id FROM RESULTS86a Where SECOND_A.ID = RESULTS86a.ID);
COMMIT;

drop table RESULTS_86;

CREATE TABLE RESULTS87_A AS SELECT
ID,
SECOND_A.STAGE,
AD_BASE.UPRN,
AD_BASE.PARENT_UPRN,
...
TRIM(regexp_REPLACE(second_a.ADDRESS_STRING, '[A-Z]','')) AS TEST_NUM,
UTL_MATCH.JARO_WINKLER(SECOND_A.ADDRESS_STRING,substr(SECOND_A.ADDRESS_STRING,greatest(-length(AD_BASE.ADDRESS_STRING_NOPC)),length( SECOND_A.ADDRESS_STRING))   ) AS SCORE
FROM SECOND_A, AD_BASE
WHERE SECOND_A.H3_8_P=AD_BASE.h3_8
AND UTL_MATCH.JARO_WINKLER(SECOND_A.ADDRESS_STRING,substr(SECOND_A.ADDRESS_STRING,greatest(-length(AD_BASE.ADDRESS_STRING_NOPC)),length( SECOND_A.ADDRESS_STRING))   ) >0.8
AND instr(second_a.ADDRESS_STRING,AD_BASE.ABBR_STREET1,1,1)>0
and AD_BASE.build_no=second_a.build_no;

CREATE TABLE RESULTS87_B AS SELECT
ID,
SECOND_A.STAGE,
AD_BASE.UPRN,
AD_BASE.PARENT_UPRN,
...
FROM SECOND_A, AD_BASE
WHERE  SECOND_A.H3_8_p=AD_BASE.h3_8
AND UTL_MATCH.JARO_WINKLER(SECOND_A.ADDRESS_STRING,substr(SECOND_A.ADDRESS_STRING,-length(AD_BASE.ADDRESS_STRING_NOPC),length( SECOND_A.ADDRESS_STRING)) ) >0.85
...
AND INSTR(second_a.ADDRESS_STRING,AD_BASE.abbr_street1,1,1)>0
AND INSTR(AD_BASE.ADDRESS_STRING_NOPC,second_a.BUILD_NO,1,1)>0;

CREATE TABLE RESULTS87_C AS SELECT
ID,
SECOND_A.STAGE,
AD_BASE.UPRN,
AD_BASE.PARENT_UPRN,
...
CREATE TABLE RESULTS87_D AS SELECT
ID,
SECOND_A.STAGE,
AD_BASE.UPRN,
AD_BASE.PARENT_UPRN,
...
--AND UTL_MATCH.JARO_WINKLER(SECOND_A.ADDRESS_STRING,substr(SECOND_A.ADDRESS_STRING,-length(AD_BASE.ADDRESS_STRING_NOPC),length( SECOND_A.ADDRESS_STRING)) ) >0.7
AND( instr(AD_BASE.address_string_nopc,second_a.add_string_working,1,1)>0 
or instr(AD_BASE.address_string_nopc,second_a.word_one|| ' '||second_a.word_two,1,1)>0)
AND instr(AD_BASE.address_string_nopc,second_a.sub_unit,1,1)>0;

CREATE TABLE RESULTS87_E AS SELECT
ID,
SECOND_A.STAGE,
AD_BASE.UPRN,
AD_BASE.PARENT_UPRN,
...
FROM SECOND_A, AD_BASE
WHERE  SECOND_A.H3_8_p=AD_BASE.h3_8
AND UTL_MATCH.JARO_WINKLER(SECOND_A.ADD_NO_SPACE,regexp_REPLACE(AD_BASE.ADDRESS_STRING_NOPC,' ','' ) )>0.8
AND instr(AD_BASE.address_string_nopc,second_a.BUILD_NO,1,1)>0
AND INSTR(second_a.ADDRESS_STRING,AD_BASE.abbr_street1,1,1)>0;
--AND instr(AD_BASE.address_string_nopc,second_a.sub_unit,1,1)>0;

CREATE TABLE UNION_C
AS
select ID,UPRN, PARENT_UPRN, STAGE, ADDRESS_STRING, ADDRESS_STRING_NOPC , SCORE from RESULTS87_A
union
select ID,UPRN, PARENT_UPRN, STAGE,  ADDRESS_STRING, ADDRESS_STRING_NOPC  , SCORE from RESULTS87_B
union 
select ID,UPRN, PARENT_UPRN, STAGE, ADDRESS_STRING, ADDRESS_STRING_NOPC  , SCORE from RESULTS87_C
union 
select ID,UPRN, PARENT_UPRN, STAGE, ADDRESS_STRING, ADDRESS_STRING_NOPC  , SCORE from RESULTS87_D
union
select ID,UPRN, PARENT_UPRN, STAGE, ADDRESS_STRING, ADDRESS_STRING_NOPC  , SCORE from RESULTS87_E;

UPDATE UNION_C SET STAGE= '87';

CREATE TABLE RESULTS87a AS SELECT DISTINCT ID,STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC,SCORE,MAX_SCORE,COUNT_P_UPRN FROM(
SELECT ID, STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC, SCORE,
mAX(SCORE) OVER (PARTITION BY ID) AS MAX_SCORE,
DENSE_RANK() OVER(PARTITION BY ID ORDER BY PARENT_UPRN) AS COUNT_P_UPRN
FROM UNION_C)
...
DELETE FROM SECOND_A
WHERE EXISTS( SELECT id FROM RESULTS87a Where SECOND_A.ID = RESULTS87a.ID);
COMMIT;

drop table UNION_C;

drop table RESULTS87_A;
drop table RESULTS87_B;
drop table RESULTS87_C;
drop table RESULTS87_D;
drop table RESULTS87_E;

CREATE TABLE RESULTS88_A AS SELECT
ID,
SECOND_A.STAGE,
AD_BASE.UPRN,
AD_BASE.PARENT_UPRN,
...
UTL_MATCH.JARO_WINKLER(SECOND_A.ADDRESS_STRING,substr(SECOND_A.ADDRESS_STRING,greatest(-length(AD_BASE.ADDRESS_STRING_NOPC)),length( SECOND_A.ADDRESS_STRING))   ) AS SCORE
FROM SECOND_A, AD_BASE
WHERE  SECOND_A.H3_10_P=AD_BASE.h3_10
AND instr(second_a.ADDRESS_STRING,ad_base.word_one,1,1)>0
and CLASSIFICATION_TERTIARY ='Care / Nursing Home';
--Communal Residence;

UPDATE RESULTS88_A SET STAGE= '88';

CREATE TABLE RESULTS88a AS SELECT DISTINCT ID,STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC,SCORE,MAX_SCORE,COUNT_P_UPRN FROM(
SELECT ID, STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC, SCORE,
mAX(SCORE) OVER (PARTITION BY ID) AS MAX_SCORE,
DENSE_RANK() OVER(PARTITION BY ID ORDER BY PARENT_UPRN) AS COUNT_P_UPRN
FROM RESULTS88_A)
...
AND COUNT_P_UPRN =1
ORDER BY ID, ADDRESS_STRING, ADDRESS_STRING_NOPC;
ALTER TABLE RESULTS88a COMPRESS;

DELETE FROM SECOND_A
WHERE EXISTS( SELECT id FROM RESULTS88a Where SECOND_A.ID = RESULTS88a.ID);
COMMIT;

drop table RESULTS88_A;

CREATE TABLE RESULTS89_A AS SELECT
ID,
SECOND_A.STAGE,
AD_BASE.UPRN,
AD_BASE.PARENT_UPRN,
...
FROM SECOND_A, AD_BASE
WHERE  SECOND_A.H3_8_P=AD_BASE.h3_8
--and CLASSIFICATION_TERTIARY ='Communal Residence'
and CLASSIFICATION_TERTIARY ='Care / Nursing Home'
and length(ad_base.build_no)=length(second_a.build_no)
AND ((instr(AD_BASE.address_string_nopc,TRIM(regexp_REPLACE(second_a.ADDRESS_STRING, '[A-Z]','')),1,1)>0) or (ad_base.build_no between second_a.range_lower and second_a.range_upper)
or (second_a.build_no between ad_base.range_lower and ad_base.range_upper));
...
CREATE TABLE RESULTS89_B AS SELECT
ID,
SECOND_A.STAGE,
AD_BASE.UPRN,
AD_BASE.PARENT_UPRN,
...
AD_BASE.ADDRESS_STRING_NOPC,
SECOND_A.ADDRESS_STRING,
regexp_REPLACE(second_a.ADD_STRING_working,ad_base.post_town,'') as  cleaner_add_string_working,
substr(SECOND_A.ADDRESS_STRING,greatest(-length(AD_BASE.ADDRESS_STRING_NOPC)),length( SECOND_A.ADDRESS_STRING))  AS TEST,
TRIM(regexp_REPLACE(second_a.ADDRESS_STRING, '[A-Z]','')) AS TEST_NUM,
UTL_MATCH.JARO_WINKLER(SECOND_A.ADDRESS_STRING,substr(SECOND_A.ADDRESS_STRING,greatest(-length(AD_BASE.ADDRESS_STRING_NOPC)),length( SECOND_A.ADDRESS_STRING))   ) AS SCORE
FROM SECOND_A, AD_BASE
WHERE  SECOND_A.H3_8_P=AD_BASE.h3_8
and UTL_MATCH.JARO_WINKLER(SECOND_A.ADDRESS_STRING,substr(SECOND_A.ADDRESS_STRING,greatest(-length(AD_BASE.ADDRESS_STRING_NOPC)),length( SECOND_A.ADDRESS_STRING))   ) >0.80
and CLASSIFICATION_TERTIARY ='Care / Nursing Home'AND  UTL_MATCH.JARO_WINKLER(regexp_REPLACE(second_a.ADD_STRING_working,ad_base.address_line_3,''),AD_BASE.abbr_street1)>0.80;

CREATE TABLE RESULTS89_C AS SELECT
ID,
SECOND_A.STAGE,
AD_BASE.UPRN,
AD_BASE.PARENT_UPRN,
...
FROM SECOND_A, AD_BASE
WHERE  SECOND_A.H3_8_P=AD_BASE.h3_8
AND instr(second_a.ADDRESS_STRING,ad_base.word_one||' '||ad_base.word_TWO,1,1)>0
and CLASSIFICATION_TERTIARY ='Care / Nursing Home';

CREATE TABLE UNION_D
AS
select ID,UPRN, PARENT_UPRN, STAGE, ADDRESS_STRING, ADDRESS_STRING_NOPC , SCORE from RESULTS89_A
union 
select ID,UPRN, PARENT_UPRN, STAGE, ADDRESS_STRING, ADDRESS_STRING_NOPC  , SCORE from RESULTS89_B
union 
select ID,UPRN, PARENT_UPRN, STAGE, ADDRESS_STRING, ADDRESS_STRING_NOPC  , SCORE from RESULTS89_C;

UPDATE UNION_D SET STAGE= '89';

CREATE TABLE RESULTS89a AS SELECT DISTINCT ID,STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC,SCORE,MAX_SCORE,COUNT_P_UPRN FROM(
SELECT ID, STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC, SCORE,
mAX(SCORE) OVER (PARTITION BY ID) AS MAX_SCORE,
DENSE_RANK() OVER(PARTITION BY ID ORDER BY PARENT_UPRN) AS COUNT_P_UPRN
FROM UNION_D)
...
AND COUNT_P_UPRN =1
ORDER BY ID, ADDRESS_STRING, ADDRESS_STRING_NOPC;
ALTER TABLE RESULTS89a COMPRESS;

DELETE FROM SECOND_A
WHERE EXISTS( SELECT id FROM RESULTS89a Where SECOND_A.ID = RESULTS89a.ID);
COMMIT;

drop table UNION_D;

drop table RESULTS89_A;
drop table RESULTS89_B;
drop table RESULTS89_C;

CREATE TABLE RESULTS90_A AS SELECT
ID,
SECOND_A.STAGE,
AD_BASE.UPRN,
AD_BASE.PARENT_UPRN,
...
FROM SECOND_A, AD_BASE
WHERE  SECOND_A.H3_8_P=AD_BASE.h3_8
AND instr(regexp_REPLACE(ad_base.ADDRESS_STRING_nopc,' ',''),second_a.word_one||second_a.word_TWO,1,1)>0
--and length(ad_base.build_no)=length(second_a.build_no)
AND instr(AD_BASE.address_string_nopc,TRIM(regexp_REPLACE(second_a.ADDRESS_STRING, '[A-Z]','')),1,1)>0
AND AD_BASE.BUILD_NO=TRIM(regexp_REPLACE(second_a.ADDRESS_STRING, '[A-Z]',''));

UPDATE RESULTS90_A SET STAGE= '90';

CREATE TABLE RESULTS90a AS SELECT DISTINCT ID,STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC,SCORE,MAX_SCORE,COUNT_P_UPRN FROM(
SELECT ID, STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC, SCORE,
mAX(SCORE) OVER (PARTITION BY ID) AS MAX_SCORE,
DENSE_RANK() OVER(PARTITION BY ID ORDER BY PARENT_UPRN) AS COUNT_P_UPRN
FROM RESULTS90_A)
...
AND COUNT_P_UPRN =1
ORDER BY ID, ADDRESS_STRING, ADDRESS_STRING_NOPC;
ALTER TABLE RESULTS90a COMPRESS;

DELETE FROM SECOND_A
WHERE EXISTS( SELECT id FROM RESULTS90a Where SECOND_A.ID = RESULTS90a.ID);
COMMIT;

drop table RESULTS90_A;

CREATE TABLE RESULTS91 AS SELECT
ID,
SECOND_A.STAGE,
AD_BASE.UPRN,
AD_BASE.PARENT_UPRN,
...
UPDATE RESULTS91 SET STAGE= 91;

CREATE TABLE RESULTS91a AS SELECT DISTINCT ID,STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC,SCORE,MAX_SCORE,COUNT_P_UPRN FROM(
SELECT ID, STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC, SCORE,
mAX(SCORE) OVER (PARTITION BY ID) AS MAX_SCORE,
DENSE_RANK() OVER(PARTITION BY ID ORDER BY PARENT_UPRN) AS COUNT_P_UPRN
FROM RESULTS91)
...
AND COUNT_P_UPRN =1
ORDER BY ID, ADDRESS_STRING, ADDRESS_STRING_NOPC;
ALTER TABLE RESULTS91a
COMPRESS;

 DELETE FROM SECOND_A
WHERE EXISTS( SELECT id FROM RESULTS91a Where SECOND_A.ID = RESULTS91a.ID);
COMMIT;

drop table RESULTS91;

CREATE TABLE RESULTS92 AS SELECT
ID,
SECOND_A.STAGE,
AD_BASE.UPRN,
AD_BASE.PARENT_UPRN,
...
UPDATE RESULTS92 SET STAGE= 92;

CREATE TABLE RESULTS92a AS SELECT DISTINCT ID,STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC,SCORE
--MAX_SCORE
,COUNT_P_UPRN FROM(
SELECT ID, STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC, SCORE,
--mAX(SCORE) OVER (PARTITION BY ID) AS MAX_SCORE,
...
--SCORE = MAX_SCORE 
 COUNT_P_UPRN =1
ORDER BY ID, ADDRESS_STRING, ADDRESS_STRING_NOPC;
ALTER TABLE RESULTS92a
COMPRESS;

 DELETE FROM SECOND_A
WHERE EXISTS( SELECT id FROM RESULTS92a Where SECOND_A.ID = RESULTS92a.ID);
COMMIT;

drop table RESULTS92;

CREATE TABLE RESULTS93 AS SELECT
ID,
SECOND_A.STAGE,
AD_BASE.UPRN,
AD_BASE.PARENT_UPRN,
...
UPDATE RESULTS93 SET STAGE= 93;

CREATE TABLE RESULTS93a AS SELECT DISTINCT ID,STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC,SCORE,MAX_SCORE,COUNT_P_UPRN FROM(
SELECT ID, STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC, SCORE,
mAX(SCORE) OVER (PARTITION BY ID) AS MAX_SCORE,
DENSE_RANK() OVER(PARTITION BY ID ORDER BY PARENT_UPRN) AS COUNT_P_UPRN,
...
ORDER BY ID, ADDRESS_STRING, ADDRESS_STRING_NOPC;
ALTER TABLE RESULTS93a
COMPRESS;

 DELETE FROM SECOND_A
WHERE EXISTS( SELECT id FROM RESULTS93a Where SECOND_A.ID = RESULTS93a.ID);
COMMIT;

drop table RESULTS93;

CREATE TABLE RESULTS94 AS SELECT
ID,
SECOND_A.STAGE,
AD_BASE.UPRN,
AD_BASE.PARENT_UPRN,
...
UPDATE RESULTS94 SET STAGE= 94;

CREATE TABLE RESULTS94a AS SELECT DISTINCT ID,STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC,SCORE,MAX_SCORE,COUNT_P_UPRN FROM(
SELECT ID, STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC, SCORE,
mAX(SCORE) OVER (PARTITION BY ID) AS MAX_SCORE,
DENSE_RANK() OVER(PARTITION BY ID ORDER BY PARENT_UPRN) AS COUNT_P_UPRN,
DENSE_RANK() OVER(PARTITION BY ID ORDER BY ADDRESS_STRING_NOPC) AS COUNT_ADDRESS_STRING_NOPC
...
and ( COUNT_P_UPRN =1 or COUNT_ADDRESS_STRING_NOPC=1)
ORDER BY ID, ADDRESS_STRING, ADDRESS_STRING_NOPC;
ALTER TABLE RESULTS94a
COMPRESS;

DELETE FROM SECOND_A
WHERE EXISTS( SELECT id FROM RESULTS94a Where SECOND_A.ID = RESULTS94a.ID);
COMMIT;

drop table RESULTS94;

------
CREATE TABLE RESULTS95 AS SELECT
ID,
SECOND_A.STAGE,
ad_base_cut.UPRN,
ad_base_cut.PARENT_UPRN,
...
TRIM(regexp_REPLACE(second_a.ADDRESS_STRING, '[A-Z]','')) AS TEST_NUM,
TRIM(regexp_REPLACE(second_a.ADDRESS_STRING, second_a.SUB_UNIT,'')) AS NO_NAME,
regexp_replace(ad_base_cut.ABBR_STREET1, '(((\w+)\s){1}).*', '\1'  ) AS STR_ONE,
UTL_MATCH.JARO_WINKLER(SECOND_A.ADDRESS_STRING,substr(SECOND_A.ADDRESS_STRING,-length(ad_base_cut.ADDRESS_STRING_NOPC),length( SECOND_A.ADDRESS_STRING)) ) AS SCORE
FROM SECOND_A, AD_BASE_CUT
WHERE  SECOND_A.H3_8_p=ad_base_cut.h3_8--and (length(ad_base_cut.build_no) = length(second_a.range_lower2) or length(ad_base_cut.build_no) = length(second_a.range_upper2))
and (second_a.build_no BETWEEN  ad_base_cut.range_lower2 AND ad_base_cut.range_upper2 
OR ad_base_cut.build_no=TO_CHAR(Second_a.range_upper) 
OR ad_base_cut.build_no=TO_CHAR(Second_a.range_LOWer) )
AND INSTR(SECOND_A.ADDRESS_STRING,regexp_replace(ad_base_cut.ABBR_STREET1, '(((\w+)\s){1}).*', '\1'  ),1,1)>0
AND INSTR(SECOND_A.ADDRESS_STRING,regexp_replace(ad_base_cut.ABBR_STREET1, '(((\w+)\s){2}).*', '\1'  ),1,1)>0;
--92 not finished partion by lat n long?

UPDATE RESULTS95 SET STAGE= 95;

CREATE TABLE RESULTS95a AS SELECT DISTINCT ID,STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC,SCORE,
--MAX_SCORE
COUNT_P_UPRN FROM(
SELECT ID, STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC, SCORE,
--mAX(SCORE) OVER (PARTITION BY ID) AS MAX_SCORE,
...
--SCORE = MAX_SCORE 
 COUNT_P_UPRN =1
ORDER BY ID, ADDRESS_STRING, ADDRESS_STRING_NOPC;
ALTER TABLE RESULTS95a
COMPRESS;

 DELETE FROM SECOND_A
WHERE EXISTS( SELECT id FROM RESULTS95a Where SECOND_A.ID = RESULTS95a.ID);
COMMIT;

drop table RESULTS95;

CREATE TABLE RESULTS96 AS SELECT
ID,
SECOND_A.STAGE,
ad_base_cut.UPRN,
ad_base_cut.PARENT_UPRN,
...
SECOND_A.ADDRESS_STRING,
substr(second_a.address_string, REGEXP_inSTR(Second_a.address_string,'[0-9]+') ,length(Second_a.address_string))as test1,
UTL_MATCH.JARO_WINKLER(substr(second_a.address_string, REGEXP_inSTR(Second_a.address_string,'[0-9]+') ),ad_base_cut.ADDRESS_STRING_NOPC ) as score
FROM SECOND_A, AD_BASE_CUT
WHERE  SECOND_A.H3_7_p=ad_base_cut.h3_7
and UTL_MATCH.JARO_WINKLER(substr(second_a.address_string, REGEXP_inSTR(Second_a.address_string,'[0-9]+') ),ad_base_cut.ADDRESS_STRING_NOPC ) >0.5
--and (second_a.build_no BETWEEN  ad_base_cut.range_lower2 AND ad_base_cut.range_upper2 
--or ad_base_cut.BUILD_NO BETWEEN SECOND_A.RANGE_LOWER AND SECOND_A.RANGE_UPPER
--OR ad_base_cut.build_no=TO_CHAR(Second_a.range_upper) 
--OR ad_base_cut.build_no=TO_CHAR(Second_a.range_LOWer) )
AND INSTR(SECOND_A.ADDRESS_STRING,regexp_replace(ad_base_cut.ABBR_STREET1, '(((\w+)\s){1}).*', '\1'  ),1,1)>0
AND INSTR(SECOND_A.ADDRESS_STRING,regexp_replace(ad_base_cut.ABBR_STREET1, '(((\w+)\s){2}).*', '\1'  ),1,1)>0;

UPDATE RESULTS96 SET STAGE= 96;

CREATE TABLE RESULTS96a AS SELECT DISTINCT ID,STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC,SCORE,MAX_SCORE,COUNT_P_UPRN FROM(
SELECT ID, STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC, SCORE,
mAX(SCORE) OVER (PARTITION BY ID) AS MAX_SCORE,
DENSE_RANK() OVER(PARTITION BY ID ORDER BY PARENT_UPRN) AS COUNT_P_UPRN,
DENSE_RANK() OVER(PARTITION BY ID ORDER BY ADDRESS_STRING_NOPC) AS COUNT_ADDRESS_STRING_NOPC
...
and ( COUNT_P_UPRN =1 or COUNT_ADDRESS_STRING_NOPC=1)
ORDER BY ID, ADDRESS_STRING, ADDRESS_STRING_NOPC;
ALTER TABLE RESULTS96a
COMPRESS;

 DELETE FROM SECOND_A
WHERE EXISTS( SELECT id FROM RESULTS96a Where SECOND_A.ID = RESULTS96a.ID);
COMMIT;

drop table RESULTS96;

CREATE TABLE RESULTS97 AS SELECT
ID,
SECOND_A.STAGE,
ad_base_cut.UPRN,
ad_base_cut.PARENT_UPRN,
...
FROM SECOND_A, AD_BASE_cut
WHERE  SECOND_A.H3_8_p=ad_base_cut.h3_8
and UTL_MATCH.JARO_WINKLER(TRIM(substr(second_a.address_string, REGEXP_inSTR(Second_a.address_string,'[0-9]+') )),ad_base_cut.ADDRESS_STRING_NOPC ) >0.88

and 
(second_a.build_no BETWEEN  ad_base_cut.range_lower2 AND ad_base_cut.range_upper2 
OR ad_base_cut.BUILD_NO BETWEEN SECOND_A.RANGE_LOWER AND SECOND_A.RANGE_UPPER
OR ad_base_cut.build_no=TO_CHAR(Second_a.range_upper) 
OR ad_base_cut.build_no=TO_CHAR(Second_a.range_LOWer) );

UPDATE RESULTS97 SET STAGE= 97;

CREATE TABLE RESULTS97a AS SELECT DISTINCT ID,STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC,SCORE,MAX_SCORE,COUNT_P_UPRN FROM(
SELECT ID, STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC, SCORE,
mAX(SCORE) OVER (PARTITION BY ID) AS MAX_SCORE,
DENSE_RANK() OVER(PARTITION BY ID ORDER BY PARENT_UPRN) AS COUNT_P_UPRN,
DENSE_RANK() OVER(PARTITION BY ID ORDER BY ADDRESS_STRING_NOPC) AS COUNT_ADDRESS_STRING_NOPC
...
and ( COUNT_P_UPRN =1 or COUNT_ADDRESS_STRING_NOPC=1)
ORDER BY ID, ADDRESS_STRING, ADDRESS_STRING_NOPC;
ALTER TABLE RESULTS97a
COMPRESS;

  DELETE FROM SECOND_A
WHERE EXISTS( SELECT id FROM RESULTS97a Where SECOND_A.ID = RESULTS97a.ID);
COMMIT;

drop table RESULTS97;

create table results98 as SELECT DISTINCT
SECOND_A.ID,
SECOND_A.STAGE,
SECOND_A.ADDRESS_STRING,
SECOND_A.ADD_NUM as in_num,
...
and AD_BASE_CUT.DESCRIPTION is not null
AND  (INSTR(SECOND_A.CURRENT_LINE1 ,AD_BASE_CUT.DESCRIPTION,1,1)>0 or INSTR(SECOND_A.CURRENT_LINE1 ,AD_BASE_CUT.ABBR_STREET1,1,1)>0)
AND (SECOND_A.BUILD_NO = AD_BASE_CUT.BUILD_NO or SECOND_A.BUILD_NO is null);

UPDATE RESULTS98 SET STAGE= 98;

CREATE TABLE RESULTS98a AS SELECT DISTINCT ID,STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC,SCORE,MAX_SCORE,COUNT_P_UPRN FROM(
SELECT ID, STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC, SCORE,
mAX(SCORE) OVER (PARTITION BY ID) AS MAX_SCORE,
DENSE_RANK() OVER(PARTITION BY ID ORDER BY PARENT_UPRN) AS COUNT_P_UPRN,
DENSE_RANK() OVER(PARTITION BY ID ORDER BY ADDRESS_STRING_NOPC) AS COUNT_ADDRESS_STRING_NOPC
...
and ( COUNT_P_UPRN =1 or COUNT_ADDRESS_STRING_NOPC=1)
ORDER BY ID, ADDRESS_STRING, ADDRESS_STRING_NOPC;
ALTER TABLE RESULTS98a
COMPRESS;

  DELETE FROM SECOND_A
WHERE EXISTS( SELECT id FROM RESULTS98a Where SECOND_A.ID = RESULTS98a.ID);
COMMIT;

drop table RESULTS98;

--and CLASSIFICATION_TERTIARY ='Care / Nursing Home';
--and instr(second_a.add_string_working,ad_base_cut.build_no,1,1)>0
...
union 
select ID,STAGE,UPRN, parent_uprn, ADDRESS_STRING, ADDRESS_STRING_NOPC from results88a
union 
select ID,STAGE,UPRN, parent_uprn, ADDRESS_STRING, ADDRESS_STRING_NOPC from results89a
union 
select ID,STAGE,UPRN, parent_uprn, ADDRESS_STRING, ADDRESS_STRING_NOPC from results90a
union 
select ID,STAGE,UPRN, parent_uprn, ADDRESS_STRING, ADDRESS_STRING_NOPC from results91a
union 
select ID,STAGE,UPRN, parent_uprn, ADDRESS_STRING, ADDRESS_STRING_NOPC from results92a
union 
select ID,STAGE,UPRN, parent_uprn, ADDRESS_STRING, ADDRESS_STRING_NOPC from results93a
union 
select ID,STAGE,UPRN, parent_uprn, ADDRESS_STRING, ADDRESS_STRING_NOPC from results94a
union 
select ID,STAGE,UPRN, parent_uprn, ADDRESS_STRING, ADDRESS_STRING_NOPC from results95a
union 
select ID,STAGE,UPRN, parent_uprn, ADDRESS_STRING, ADDRESS_STRING_NOPC from results96a
union 
select ID,STAGE,UPRN, parent_uprn, ADDRESS_STRING, ADDRESS_STRING_NOPC from results97a
union 
select ID,STAGE,UPRN, parent_uprn, ADDRESS_STRING, ADDRESS_STRING_NOPC from results98a
order by STAGE,parent_uprn,uprn;

SELECT DISTINCT ID FROM UPRNSEEDing2 --10750  Rows -- 1537 rows lost from uprn_seeding......

SELECT DISTINCT ID FROM second_a
...
---reset--
drop table RESULTS_TEST3A;
drop table RESULTS_TEST4A;
drop table RESULTS_TEST11A;
drop table RESULTS_TEST5A;
drop table RESULTS_TEST7A;
drop table RESULTS_TEST8A;
drop table RESULTS_TEST9A;
drop table RESULTS57A;
drop table RESULTS58;
drop table RESULTS58A;
drop table RESULTS59A;
drop table RESULTS60A;
drop table RESULTS61A;
drop table RESULTS62;

drop table RESULTS10A;
drop table RESULTS10B;
drop table RESULTS11A;
drop table RESULTS12A;
drop table RESULTS13A;
drop table RESULTS14A;
drop table RESULTS15A;
drop table RESULTS16A;
drop table RESULTS17;
drop table RESULTS17A;
drop table RESULTS18A;
drop table RESULTS19A;
drop table RESULTS1A;
drop table RESULTS20A;
drop table RESULTS21A;
drop table RESULTS22A;
drop table RESULTS23A;
drop table RESULTS24A;
drop table RESULTS25A;
drop table RESULTS26A;
drop table RESULTS27A;
drop table RESULTS28A;
drop table RESULTS29A;
drop table RESULTS2A;
drop table RESULTS30A;
drop table RESULTS31A;
drop table RESULTS32;
drop table RESULTS32A;
drop table RESULTS33;
drop table RESULTS33A;
drop table RESULTS34A;
drop table RESULTS35A;
drop table RESULTS36A;
drop table RESULTS37A;
drop table RESULTS38A;
drop table RESULTS39A;
drop table RESULTS40A;
drop table RESULTS41A;
drop table RESULTS42A;
drop table RESULTS43;
drop table RESULTS43A;
drop table RESULTS44A;
drop table RESULTS45A;
drop table RESULTS46A;
drop table RESULTS47A;
drop table RESULTS48A;
drop table RESULTS49A;
drop table RESULTS50A;
drop table RESULTS51A;
drop table RESULTS52A;
drop table RESULTS53A;
drop table RESULTS54A;
drop table RESULTS55A;
...
drop table RESULTS56A;
drop table RESULTS3A;
drop table RESULTS3AA;
drop table RESULTS4A;
drop table RESULTS5A;
drop table RESULTS6A;
drop table RESULTS7A;
drop table RESULTS8A;
drop table RESULTS9A;
drop table RESULTSA;
drop table RESULTS1I;
drop table RESULTS1II;
drop table RESULTS41;
...
drop table RESULTS42_3;
drop table RESULTS57;
drop table RESULTS62A;
drop table RESULTS63A;
drop table RESULTS64A;
drop table RESULTS65A;
drop table RESULTS66A;
drop table RESULTS67A;
drop table RESULTS68A;
drop table RESULTS69A;
drop table RESULTS70A;
drop table RESULTS71A;
drop table RESULTS72A;
drop table RESULTS73A;
drop table RESULTS74A;
drop table RESULTS76A;
drop table RESULTS75A;
drop table RESULTS78A;
drop table RESULTS79A;
drop table RESULTS80A;
drop table RESULTS81A;
drop table RESULTS82A;
drop table RESULTS83A;
drop table RESULTS84A;
drop table RESULTS86A;
drop table RESULTS85A;
drop table RESULTS87A;
drop table RESULTS88A;
drop table RESULTS83AA ; 
drop table RESULTS89A ; 
drop table RESULTS90A ; 
drop table RESULTS_85 ; 
drop table RESULTS_84 ;
drop table RESULTS91A ; 
drop table RESULTS92A ;
drop table RESULTS93A ;
drop table RESULTS94A ;
drop table RESULTS95A ;
drop table RESULTS96A ;
drop table RESULTS97A ;


create table check_chi as SELECT id FROM add_in 
MINUS 
SELECT  id from UPRNSEEDING2

create table check_chi3 as SELECT id FROM second_a
MINUS 
SELECT  id from check_chi 
