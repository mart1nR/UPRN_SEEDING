CREATE TABLE AD_BASE_CUT_CUT AS SELECT
* FROM AD_BASE_CUT WHERE 
...
drop table "MARTIR03"."UNION_A";

drop table "MARTIR03"."RESULTS_82_A";
drop table "MARTIR03"."RESULTS_82_B";
drop table "MARTIR03"."RESULTS_82_C";
drop table "MARTIR03"."RESULTS_82_D";
drop table "MARTIR03"."RESULTS_82_E";
drop table "MARTIR03"."RESULTS_82_F";
...
drop table "MARTIR03"."UNION_B";

drop table "MARTIR03"."RESULTS_83_A";
drop table "MARTIR03"."RESULTS_83_B";
drop table "MARTIR03"."RESULTS_83_C";
drop table "MARTIR03"."RESULTS_83_D";
drop table "MARTIR03"."RESULTS_83_E";
drop table "MARTIR03"."RESULTS_83_F";
drop table "MARTIR03"."RESULTS_83_G";
...
drop table "MARTIR03"."RESULTS_84";
--AND UTL_MATCH.JARO_WINKLER(SECOND_A.ADD_NO_SPACE,regexp_REPLACE(AD_BASE_cut.ADDRESS_STRING_NOPC,' ','' ) )>0.7
--AND instr(ad_base_cut.address_string_nopc,second_a.BUILD_NO,1,1)>0
--AND INSTR(second_a.ADDRESS_STRING,ad_base_cut.abbr_street1,1,1)>0
...
drop table "MARTIR03"."RESULTS_85";
...
drop table MARTIR03.RESULTS_86;
...
WHERE  instr(SECOND_A.H3_8_P,AD_BASE.h3_8,1,1)>0
...
drop table "MARTIR03"."UNION_C";

drop table "MARTIR03"."RESULTS87_A";
drop table "MARTIR03"."RESULTS87_A";
drop table "MARTIR03"."RESULTS87_C";
drop table "MARTIR03"."RESULTS87_D";
drop table "MARTIR03"."RESULTS87_E";
...
drop table "MARTIR03"."RESULTS88_A";
...
drop table "MARTIR03"."UNION_D";

drop table "MARTIR03"."RESULTS89_A";
drop table "MARTIR03"."RESULTS89_B";
drop table "MARTIR03"."RESULTS89_C";
...
drop table "MARTIR03"."RESULTS90_A";
...
create table results95 as SELECT DISTINCT
SECOND_A.ID,
SECOND_A.STAGE,
SECOND_A.ADDRESS_STRING,
SECOND_A.ADD_NUM as in_num,
...
CREATE TABLE RESULTS95a AS SELECT DISTINCT ID,STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC,SCORE,MAX_SCORE,COUNT_P_UPRN FROM(
SELECT ID, STAGE,UPRN,PARENT_UPRN, ADDRESS_STRING, ADDRESS_STRING_NOPC, SCORE,
mAX(SCORE) OVER (PARTITION BY ID) AS MAX_SCORE,
DENSE_RANK() OVER(PARTITION BY ID ORDER BY PARENT_UPRN) AS COUNT_P_UPRN,
DENSE_RANK() OVER(PARTITION BY ID ORDER BY ADDRESS_STRING_NOPC) AS COUNT_ADDRESS_STRING_NOPC
...
SELECT DISTINCT ID FROM UPRNSEEDING --10750  Rows -- 1537 rows lost from uprn_seeding......
...
drop table "MARTIR03"."RESULTS82A";
drop table "MARTIR03"."RESULTS83A";
drop table "MARTIR03"."RESULTS84A";
drop table "MARTIR03"."RESULTS86A";
drop table "MARTIR03"."RESULTS85A";
drop table "MARTIR03"."RESULTS87A";
drop table "MARTIR03"."RESULTS88A";
drop table "MARTIR03"."RESULTS83AA" ; 
drop table "MARTIR03"."RESULTS89A" ; 
drop table "MARTIR03"."RESULTS90A" ; 
drop table "MARTIR03"."RESULTS_85" ; 
drop table "MARTIR03"."RESULTS_84" ;
drop table "MARTIR03"."RESULTS91A" ; 
drop table "MARTIR03"."RESULTS92A" ;
drop table "MARTIR03"."RESULTS93A" ;
drop table "MARTIR03"."RESULTS94A" ;
drop table "MARTIR03"."RESULTS95A" ;